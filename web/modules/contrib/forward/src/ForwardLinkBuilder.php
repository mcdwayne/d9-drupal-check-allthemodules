  ...
  private function buildLink(EntityInterface $entity, array $settings) {
    ...
    switch ($link_style) {
      ...
      case 1:
        ...
        $render_array = ['#theme' => 'image', '#uri' => $img, '#alt' => $title, '#attributes' => ['class' => ['forward-icon']]];
      ...
      case 2:
        $img = $custom_icon ? $custom_icon : $default_icon;
        $render_array = [
          'image' => ['#theme' => 'image', '#uri' => $img, '#alt' => $title, '#attributes' => ['class' => ['forward-icon', 'forward-icon-margin']]],
