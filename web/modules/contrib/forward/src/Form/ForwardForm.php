...
class ForwardForm extends FormBase implements BaseFormIdInterface {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, array $settings = NULL) {
    ...
    if ($settings['forward_personal_message']) {
      $form['message']['message'] = [
        ...
        '#cols' => 50,
        '#rows' => 5,
        '#description' => $settings['forward_personal_message_filter'] ? $this->t('These HTML tags are allowed in this field: @tags.', ['@tags' => $settings['forward_personal_message_tags']]) : t('HTML is not allowed in this field.'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->moduleHandler->invokeAll('forward_entity', [$account, $entity, $form_state]);
