...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($entity_types as $type => $info) {
      if (is_a($info, 'Drupal\Core\Entity\ContentEntityType')) {
        ...
        if (!in_array($type, ['block_content', 'contact_message', 'file', 'menu_link_content', 'node', 'shortcut'])) {
    ...
    // View Modes.
    $modes = ['full' => t('Full entity'), 'teaser' => t('Teaser')];
    $options = [];
    $defaults = [];
    ...
    $form['forward_interface']['forward_interface_type'] = [
      ...
      '#options' => ['link' => t('Link to separate page'), 'form' => t('Display inline form')],
    ...
    $form['forward_interface']['forward_link_options']['forward_link_style'] = [
      ...
      '#options' => [0 => $this->t('Text only'), 1 => t('Icon only'), 2 => t('Icon and text')],
    ...
    $form['forward_flood_control_options']['forward_flood_control_limit'] = [
      ...
      '#options' => ['1' => '1', '5' => '5', '10' => '10', '15' => '15', '20' => '20', '25' => '25', '30' => '30', '35' => '35', '40' => '40', '50' => '50'],
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($modes as $mode) {
      $this->config('forward.settings')->set('forward_view_' . $mode, !empty($values[$mode]));
    }
