...
/**
 * @file
 * Contains \Drupal\image_base64_formatter\Plugin\Field\FieldFormatter\ImageBase64Formatter.
 */
...
/**
 * Plugin implementation of the 'image_base64' formatter.
 *
 * @FieldFormatter(
 *   id = "image_base64",
 ...
 * )
 */
class ImageBase64Formatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
    ...
    */
    public function viewElements(FieldItemListInterface $items, $langcode) {
        ...
        foreach ($files as $delta => $file) {
            ...
            // if you need image timestamp
            //$image_timestamp = $file->getCreatedTime();
