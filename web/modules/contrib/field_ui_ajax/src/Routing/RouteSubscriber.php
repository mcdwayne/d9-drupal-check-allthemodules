...
/**
 * @file
 * Contains \Drupal\field_ui_ajax\Routing\RouteSubscriber.
 */
...
class RouteSubscriber extends RouteSubscriberBase {
  ...
  protected function alterRoutes(RouteCollection $collection) {
      ...
      if ($route_name = $entity_type->get('field_ui_base_route')) {
        ...
        $route = new Route(
          ...
          [
            ...
            '_controller_class' => 'controller.field_ui_entity_form',
            '_controller_method' => 'fieldConfigEditForm',
        ...
        $route = new Route(
          ...
          [
            ...
            '_controller_class' => 'controller.field_ui_entity_form',
            '_controller_method' => 'storageConfigEditForm',
          ] + $defaults,
        ...
        $route = new Route(
          ...
          [
            ...
            '_controller_class' => 'controller.field_ui_entity_form',
            '_controller_method' => 'fieldConfigDeleteForm',
          ] + $defaults,
        ...
        $route = new Route(
          ...
          array(
            '_field_ui_form' => '\Drupal\field_ui_ajax\Form\FieldStorageAjaxAddForm',
            '_method' => 'fieldStorageAddForm',
            '_title' => 'Add field',
          ) + $defaults,
        ...
        $route = new Route(
          ...
          [
            ...
            '_controller_class' => 'controller.field_ui_entity_form',
            '_controller_method' => 'entityFormDisplayPage',
        ...
        $route = new Route(
          ...
          [
            ...
            '_controller_class' => 'controller.field_ui_entity_form',
            '_controller_method' => 'entityViewDisplayPage',
    ...
    // View modes management pages.
    // Add form.
    $add_view = $collection->get('entity.entity_view_mode.add_form');
    $add_view->setOption('_field_ui_ajax', TRUE);
    $add_view->setDefault('_controller_class', 'controller.field_ui_entity_form');
    $add_view->setDefault('_controller_method', 'entityViewModeAdd');
    // Delete form.
    $add_view = $collection->get('entity.entity_view_mode.delete_form');
    $add_view->setOption('_field_ui_ajax', TRUE);
    $add_view->setDefault('_controller_class', 'controller.field_ui_entity_form');
    $add_view->setDefault('_controller_method', 'entityViewModeDelete');
    // Edit form.
    $add_view = $collection->get('entity.entity_view_mode.edit_form');
    $add_view->setOption('_field_ui_ajax', TRUE);
    $add_view->setDefault('_controller_class', 'controller.field_ui_entity_form');
    $add_view->setDefault('_controller_method', 'entityViewModeEdit');

    // Form modes management pages.
    // Add form.
    $add_form = $collection->get('entity.entity_form_mode.add_form');
    $add_form->setOption('_field_ui_ajax', TRUE);
    $add_form->setDefault('_controller_class', 'controller.field_ui_entity_form');
    $add_form->setDefault('_controller_method', 'entityViewModeAdd');
    // Delete form.
    $add_form = $collection->get('entity.entity_form_mode.delete_form');
    $add_form->setOption('_field_ui_ajax', TRUE);
    $add_form->setDefault('_controller_class', 'controller.field_ui_entity_form');
    $add_form->setDefault('_controller_method', 'entityFormModeDelete');
    // Edit form.
    $add_form = $collection->get('entity.entity_form_mode.edit_form');
    $add_form->setOption('_field_ui_ajax', TRUE);
    $add_form->setDefault('_controller_class', 'controller.field_ui_entity_form');
    $add_form->setDefault('_controller_method', 'entityFormModeEdit');
  }
