...
/**
 * @file
 * Contains \Drupal\rut\Command\ValidateCommand.
 */
...
class ValidateCommand extends Command {
  ...
  protected function execute(InputInterface $input, OutputInterface $output) {
    ...
    if (RutUtil::validateRut($rut, $dv)) {
      $io->success(
            sprintf($this->trans('command.rut.validate.messages.success'), RutUtil::formatterRut($rut, $dv))
        );
    }
    else {
      $io->error(
