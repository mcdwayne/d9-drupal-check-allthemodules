 ...
 */
class PermanentEntityRevisionRevertTranslationForm extends PermanentEntityRevisionRevertForm {
  ...
  public function getFormId() {
    return 'permanent_entity_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $permanent_entity_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $permanent_entity_revision);
