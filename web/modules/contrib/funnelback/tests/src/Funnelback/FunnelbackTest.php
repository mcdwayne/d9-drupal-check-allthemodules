...
namespace Drupal\Tests\funnelback\Diff;
...
class FunnelbackTestCase extends TestCase {
  ...
  public function testFilterSystemQueryString() {
    ...
    $this->assertEquals($fiteredQueryString, $funnelback->filterQueryString($testQueryString));
  }
  ...
  public function testQuratorLink() {
    ...
    $this->assertEquals($expected_string, $funnelback->filterCuratorLink($raw_string));
  }
