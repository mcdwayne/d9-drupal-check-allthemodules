 ...
 * @see plugin_api
 */
interface EntityCounterSourceWithEntityConditionsInterface extends EntityCounterSourceInterface, ObjectWithPluginCollectionInterface {
  ...
  /**
   * Retrieves the entity for evaluating conditions.
   *
  ...
  /**
   * Sets the needed entity for evaluating conditions.
   *
