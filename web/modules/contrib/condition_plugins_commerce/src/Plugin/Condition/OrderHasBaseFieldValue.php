...
class OrderHasBaseFieldValue extends ConditionBase implements ContainerFactoryPluginInterface {
  ...
  public function evaluate() {
    ...
    if ($commerce_order->hasField($this->configuration['base_field']) &&
      array_key_exists('value', $commerce_order->get($this->configuration['base_field'])->first()->getValue())) {
      $value = $commerce_order->get($this->configuration['base_field'])->first()->getValue()['value'];
