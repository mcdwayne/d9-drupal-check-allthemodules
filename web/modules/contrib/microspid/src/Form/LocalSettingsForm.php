...
class LocalSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'microspid_local_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['authentication']['allow_default_login'] = [
      ...
      '#description' => $this->t('Check this box if you want to let people log in with local Drupal accounts (without using MicroSPiD). If you want to restrict this privilege to certain users you can enter the Drupal user IDs in the field below.'),
    ];
    ...
    $form['authentication']['allow_default_login_roles'] = [
      ...
      '#description' => $this->t('Roles that should be allowed to login without MicroSPiD. Examples are dev/admin roles or guest roles.'),
    ];
    $form['authentication']['allow_default_login_users'] = [
      ...
      '#description' => $this->t('Example: <i>1,2,3</i><br />A comma-separated list of user IDs that should be allowed to login without MicroSPiD.'),
    ];
