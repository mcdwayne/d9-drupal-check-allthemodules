...
/**
 * @file
 * Hooks for MicroSPiD Authentication module.
 */
 ...
 */
function hook_microspid_user_roles_alter(&$roles, $attributes) {
 ...
 */
function hook_microspid_allow_login($attributes) {
 ...
 */
function hook_microspid_account_authname_alter(&$authname, \Drupal\user\UserInterface $account) {
 ...
 */
function hook_microspid_user_attributes(\Drupal\user\UserInterface $account, $attributes) {
