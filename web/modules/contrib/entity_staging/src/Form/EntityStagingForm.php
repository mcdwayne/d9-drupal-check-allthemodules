...
namespace Drupal\entity_staging\Form;
 ...
 */
class EntityStagingForm extends ConfigFormBase implements ContainerInjectionInterface {
   ...
   * {@inheritdoc}
   *
   * @var \Drupal\entity_staging\EntityStagingManager $entity_staging_manager
   */
  public function __construct(ConfigFactoryInterface $config_factory, EntityStagingManager $entity_staging_manager) {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('entity_staging.manager')
    );
  }
  ...
  public function getEditableConfigNames() {
    return ['entity_staging.settings'];
  }
  ...
  public function getFormId() {
    return 'entity_staging_settings_form';
  }
