...
class EntityStagingManager {
  ...
  /**
   * EntityStagingManager constructor.
   *
  ...
  public function __construct(EntityTypeManagerInterface $entity_type_manager, EntityTypeBundleInfoInterface $entity_type_bundle_info, ConfigFactoryInterface $config_factory) {
    ...
    $this->config = $config_factory->get('entity_staging.settings');
    $this->editableConfig = $config_factory->getEditable('entity_staging.settings');
  }
