...
project provides an “Invite a Friend” feature that allows your users to send and
track invitations.
 ...
 * Navigate Structure » Invite types » Invite settings to check the default
   configuration.
 * Enable the invite and invite_by_email.
 ...
 * Go to the page where the block was inserted.
