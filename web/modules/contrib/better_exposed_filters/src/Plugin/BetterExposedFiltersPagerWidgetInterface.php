...
/**
 * Defines an interface for Better exposed filters pager widget plugins.
 */
interface BetterExposedFiltersPagerWidgetInterface extends PluginInspectionInterface {
