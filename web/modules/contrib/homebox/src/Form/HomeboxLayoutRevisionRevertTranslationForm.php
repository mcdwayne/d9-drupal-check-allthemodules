 ...
 * @ingroup homebox
 */
class HomeboxLayoutRevisionRevertTranslationForm extends HomeboxLayoutRevisionRevertForm {
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $container->get('entity.manager')->getStorage('homebox_layout'),
      $date_formatter,
      $language_manager,
      $time
    );
  ...
  public function getFormId() {
    return 'homebox_layout_revision_revert_translation_confirm';
  }
  ...
  protected function prepareRevertedRevision(HomeboxLayoutInterface $revision, FormStateInterface $form_state) {
    ...
    $latest_revision = $this->homeboxLayoutStorage->load($revision->id());
