...
class CSVUnitTest extends CSVUnitBase {
  ...
  public function testMigrateExceptionPathMissing() {
    $this->setExpectedException(MigrateException::class, 'You must declare the "path" to the source CSV file in your source settings.');
  ...
  public function testMigrateExceptionKeysMissing() {
    ...
    $this->setExpectedException(MigrateException::class, 'You must declare "keys" as a unique array of fields in your source settings.');
