...
Drupal.behaviors.subprofiles = {
  attach: function (context, settings) {
    ...
    $('#install-configure-form #edit-modules .form-type-checkbox', context).once('subprofiles', function() {
    ...
    var tallest = 0;
    $('#install-configure-form #edit-modules .form-type-checkbox', context)
      .each(function() {
