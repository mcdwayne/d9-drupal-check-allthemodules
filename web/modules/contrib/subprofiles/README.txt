...
profile's .info file, and consist of a set of modules available for enabling,
...
specify exactly which of the subprofile's modules to enable.
...
2. In your .profile file, or an include file loaded at install time, add an
   ...
   <code>
    /**
     * Generate an install task to install subprofile modules.
     *
     * @param $install_state
