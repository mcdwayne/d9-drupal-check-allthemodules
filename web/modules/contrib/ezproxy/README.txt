Requirements
------------
This module requires Drupal 8 or higher and EZproxy installed


Installation
------------
1. Place the ezproxy module into your modules directory (modules/contrib/ezproxy)

2. Enable the module in Extend

3. Set up access permissions in People >> Permissions for both 'administer ezproxy' and 'access exproxy content'.
...
2. Go to the configuration page for ezproxy (admin >> configuration >> ezproxy >> settings) and enter the hostname
...
Author
-----------------
Rich Dworianyn rdworianyn@gmail.com