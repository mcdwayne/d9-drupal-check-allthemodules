(function ($) {
  ...
  $(document).ready(function() {
    ...
    $( '.content-calendar .droppable' ).droppable({
      ...
      drop: function( ev, ui ) {
        ...
        if(date && nid) {
          ...
          var url = drupalSettings.path.baseUrl + 'admin/content-calendar/update-node-publish-date/' + nid + '/' + date;
    ...
    $('#edit-calendar-year').change(function() {
      document.location = drupalSettings.path.baseUrl + 'admin/content-calendar/' + $( this ).val();
    });
