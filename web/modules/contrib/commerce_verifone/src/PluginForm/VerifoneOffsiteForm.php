...
namespace Drupal\commerce_verifone\PluginForm;

use Drupal\commerce_order\Entity\OrderInterface;
use Drupal\commerce_order\Entity\OrderItemInterface;
use Drupal\commerce_payment\PluginForm\PaymentOffsiteForm;
use Drupal\commerce_verifone\DependencyInjection\PaymentHelper;
use Drupal\commerce_verifone\Plugin\Commerce\PaymentGateway\VerifonePayment;
...
class VerifoneOffsiteForm extends PaymentOffsiteForm implements ContainerInjectionInterface
{
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state)
  {
    ...
    /** @var \Drupal\commerce_verifone\Plugin\Commerce\PaymentGateway\VerifonePayment $paymentGatewayPlugin */
...
//    }
  ...
  protected function _getConfiguration()
  {
    ...
    /** @var \Drupal\commerce_verifone\Plugin\Commerce\PaymentGateway\VerifonePayment $payment_gateway_plugin */
  ...
  protected function _prepareProducts(OrderInterface $order, OrderImpl $orderImpl)
  {
    ...
    if (\count($products) > VerifonePayment::BASKET_LIMIT) {
      foreach ($products as $product) {
...
// calculation for tax return for example 24%, so we have 24/100 => 0.24 but we need int value so *100.
  ...
  {
    $configuration = $this->_getConfiguration();
    return $configuration['basket_item_sending'] === VerifonePayment::BASKET_ITEMS_SEND_FOR_ALL;
  }
