...
namespace Drupal\bulk_update_fields_commerce\Form;
...
class BulkUpdateFieldsForm extends FormBase implements FormInterface {
  ...
  /**
   * Constructs a \Drupal\bulk_update_fields_commerce\Form\BulkUpdateFieldsForm.
   *
  ...
  public function updateFields() {
    ...
    $batch = [
      ...
      'operations' => [
        [
          '\Drupal\bulk_update_fields_commerce\BulkUpdateFields::updateFields',
          [$entities, $fields],
        ],
      ],
      'finished' => '\Drupal\bulk_update_fields_commerce\BulkUpdateFields::bulkUpdateFieldsFinishedCallback',
    ];
    batch_set($batch);
