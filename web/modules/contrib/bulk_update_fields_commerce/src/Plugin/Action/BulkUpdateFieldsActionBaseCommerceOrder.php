 ...
 *
 * @Action(
 *   id = "bulk_update_fields_action_base_commerce_order",
 *   label = "Bulk Update Fields to Another Value",
 *   type = "commerce_order",
 *   confirm_form_route_name = "bulk_update_fields.form"
 * )
 */
class BulkUpdateFieldsActionBaseCommerceOrder extends ActionBase implements ContainerFactoryPluginInterface {
  /**
   * The plugin_id.
   *
   * @var pluginId
