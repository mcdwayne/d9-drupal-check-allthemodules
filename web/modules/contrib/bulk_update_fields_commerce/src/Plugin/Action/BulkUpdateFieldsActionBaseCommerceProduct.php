...
namespace Drupal\bulk_update_fields_commerce\Plugin\Action;
 ...
 *
 * @Action(
 *   id = "bulk_update_fields_action_base_commerce_product",
 *   label = "Bulk Update Fields to Another Value",
 *   type = "commerce_product",
 *   confirm_form_route_name = "bulk_update_fields.form"
 * )
 */
class BulkUpdateFieldsActionBaseCommerceProduct extends ActionBase implements ContainerFactoryPluginInterface {
  /**
   * The plugin_id.
   *
   * @var pluginId
