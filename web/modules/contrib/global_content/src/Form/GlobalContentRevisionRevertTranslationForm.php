...
/**
 * Provides a form for reverting a Global Content revision for a single translation.
 *
 * @ingroup global_content
 */
class GlobalContentRevisionRevertTranslationForm extends GlobalContentRevisionRevertForm {
  ...
  public function getFormId() {
    return 'global_content_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $global_content_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $global_content_revision);
