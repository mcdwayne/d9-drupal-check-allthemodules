...
class StandardTest extends BrowserTestBase {
  ...
  public function testStandard() {
    ...
    // Configure the block.
    $this->drupalGet('admin/structure/block/add/system_menu_block:main/admin_lte');
    ...
    // business profile modules are enabled.
