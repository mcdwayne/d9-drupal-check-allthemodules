...
namespace Drupal\cbo_organization\Plugin\EntityReferenceSelection;

use Drupal\Component\Utility\Html;
use Drupal\Core\Entity\Plugin\EntityReferenceSelection\DefaultSelection;

/**
 * Provides specific access control for the organization entity type.
 *
 ...
 * )
 */
class OrganizationSelection extends DefaultSelection {
  ...
  public function getReferenceableEntities($match = NULL, $match_operator = 'CONTAINS', $limit = 0) {
    ...
    foreach ($entities as $entity_id => $entity) {
      ...
      $options[$bundle][$entity_id] = Html::escape($this->entityManager->getTranslationFromContext($entity)->label()) . ' ' . $entity->get('description')->value;
    }
