...
namespace Drupal\social_post_weibo;
...
class WeiboPostAuthManager {
  ...
  /**
   * Returns the OAuth Verifier provided by Weibo.
   *
   * @return string
   ...
   * token is the one returned by Weibo when we first request
  ...
  public function setOauthToken($oauth_token) {
    $this->session->set('social_post_weibo_oauth_token', $oauth_token);
  }
   ...
   * user.This auth token is the one returned by Weibo when we first request
   * /oauth/request_token to then get an oauth_verifier for authorization.
   *
  ...
  public function setOauthTokenSecret($oauth_token_secret) {
    $this->session->set('social_post_weibo_oauth_token_secret', $oauth_token_secret);
  }
  ...
  public function getOauthToken() {
    return $this->session->get('social_post_weibo_oauth_token');
  }
  ...
  public function getOauthTokenSecret() {
    return $this->session->get('social_post_weibo_oauth_token_secret');
  }
