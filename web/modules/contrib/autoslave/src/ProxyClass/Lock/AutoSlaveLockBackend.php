...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\autoslave\Lock\AutoSlaveLockBackend' "modules/contrib/autoslave/src".
 */
...
namespace Drupal\autoslave\ProxyClass\Lock {
    ...
    class AutoSlaveLockBackend implements \Drupal\Core\Lock\LockBackendInterface
    {
         ...
         *
         * @var \Drupal\autoslave\Lock\AutoSlaveLockBackend
         */
        protected $service;
