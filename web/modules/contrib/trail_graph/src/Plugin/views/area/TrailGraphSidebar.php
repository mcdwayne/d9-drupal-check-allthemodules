...
namespace Drupal\trail_graph\Plugin\views\area;
 ...
 *
 * @ViewsArea("trail_graph_sidebar")
 */
class TrailGraphSidebar extends AreaPluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['first_tab'] = ['default' => 'Orphaned nodes'];
    $options['second_tab'] = ['default' => 'Trails'];
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['first_tab'] = [
      '#title' => $this->t('Text of first tab'),
      '#type' => 'textfield',
      '#default_value' => $this->options['first_tab'],
      '#size' => 50,
      '#maxlength' => 60,
    ];
    $form['second_tab'] = [
      '#title' => $this->t('Text of first tab'),
      '#type' => 'textfield',
      '#default_value' => $this->options['second_tab'],
      '#size' => 50,
      '#maxlength' => 60,
    ];
  }
  ...
  public function render($empty = FALSE) {
    if (!empty($this->options['view_to_insert'])) {
      ...
      if (in_array($search, $this->view->parent_views)) {
        ...
        $renderable = [
          '#theme' => 'trail_graph_sidebar',
          '#view' => $output,
          '#form' => NULL,
          '#first_tab' => $this->options['first_tab'],
          '#second_tab' => $this->options['second_tab'],
        ];
  ...
  public function calculateDependencies() {
    ...
    // Don't call the current view, it would result into an infinite recursion.
