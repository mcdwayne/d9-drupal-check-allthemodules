...
namespace Drupal\smartling_config_translation\Plugin\views\field;
 ...
 *
 * @ViewsField("smartling_submission_config_target_language")
 */
class ConfigTargetLanguage extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    $id = $entity->get('name')->value;
    $enity_type = $entity->get('bundle')->value;
