...
/**
 * Provides a form for reverting a Pagedesigner Element revision for a single translation.
 *
 * @ingroup pagedesigner
 */
class ElementRevisionRevertTranslationForm extends ElementRevisionRevertForm {
  ...
  public function getFormId() {
    return 'pagedesigner_element_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $pagedesigner_element_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $pagedesigner_element_revision);
