(function ($, Drupal) {
  ...
  function init(editor) {
    if (!initialized) {
      ...
      TraitManager.addType('fontawesome',
        Object.assign({}, TraitManager.defaultTrait,
          {
            ...
            getInputEl: function () {
              if (!this.inputEl) {
                var iconTrait = this;
                var container = jQuery('<div class="pd-icon-container">');
                var search = $('<input type="text" class="pd-icon-search"/>')
                container.append(search);
                search.on('keyup', function (e) {
                  var query = $(search).val();
                  if (query.length > 0) {
                    container.find("i").each(function (i, el) {
                      if ($(el).attr('class').indexOf(query) === -1) {
                ...
                for (var x in fontawesome_list) {
                  var box = $('<span class="pd-icon-item">');
                  box.on('click', function (e) {
                    iconTrait.setInputValue($(this).find('i').attr('class'));
                  });
                  var icon = $('<i class="' + x + '"></i>');
                  box.append(icon);
                ...
                if (value) {
                  container.find("i").each(function (i, el) {
                    if ($(el).attr('class') == value) {
                      var parent = $(el).parent();
                      parent.addClass('pd-icon-selected');
                      // container.find('span:first-of-type').before(parent);
                    }
                  });
                }
  ...
  Drupal.behaviors.pagedesigner_trait_icon = {
...
var fontawesome_list = {
  ...
  "far fa-flushed": "far fa-flushed",
  "far fa-folder": "far fa-folder",
  "far fa-folder-open": "far fa-folder-open",
  "far fa-frown": "far fa-frown",
  "far fa-frown-open": "far fa-frown-open",
  "far fa-futbol": "far fa-futbol",
  "far fa-gem": "far fa-gem",
  "far fa-grimace": "far fa-grimace",
  "far fa-grin": "far fa-grin",
  "far fa-grin-alt": "far fa-grin-alt",
  "far fa-grin-beam": "far fa-grin-beam",
  "far fa-grin-beam-sweat": "far fa-grin-beam-sweat",
  "far fa-grin-hearts": "far fa-grin-hearts",
  "far fa-grin-squint": "far fa-grin-squint",
  "far fa-grin-squint-tears": "far fa-grin-squint-tears",
  "far fa-grin-stars": "far fa-grin-stars",
  "far fa-grin-tears": "far fa-grin-tears",
  "far fa-grin-tongue": "far fa-grin-tongue",
  "far fa-grin-tongue-squint": "far fa-grin-tongue-squint",
  "far fa-grin-tongue-wink": "far fa-grin-tongue-wink",
  "far fa-grin-wink": "far fa-grin-wink",
  ...
  "far fa-kiss": "far fa-kiss",
  "far fa-kiss-beam": "far fa-kiss-beam",
  "far fa-kiss-wink-heart": "far fa-kiss-wink-heart",
  "far fa-laugh": "far fa-laugh",
  "far fa-laugh-beam": "far fa-laugh-beam",
  "far fa-laugh-squint": "far fa-laugh-squint",
  "far fa-laugh-wink": "far fa-laugh-wink",
  ...
  "far fa-meh-blank": "far fa-meh-blank",
  "far fa-meh-rolling-eyes": "far fa-meh-rolling-eyes",
