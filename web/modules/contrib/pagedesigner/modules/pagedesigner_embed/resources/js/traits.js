(function ($, Drupal) {
  ...
  function initEmbeds() {
    ...
    Drupal.ajax
      (
        {
          url: '/pagedesigner/form/asset/search/embed'
        }
      )
      .execute()
      .done(
  ...
  function init(editor) {
    ...
    am.getType('embed').upload = function (file) {
      return;
      var reader = new FileReader();
      reader.onload = function () {
        Drupal.restconsumer.upload(
          '/file/upload/media/embed/field_media_image',
          file.name,
          reader.result
        )
  ...
  Drupal.behaviors.pagedesigner_embed = {
