...
use Drupal\affiliates_connect\Annotation\AffiliatesNetwork;
...
class AffiliatesNetworkManager extends DefaultPluginManager {
  ...
  public function __construct(
    ...
    parent::__construct('Plugin/AffiliatesNetwork', $namespaces, $module_handler, AffiliatesNetworkInterface::class, AffiliatesNetwork::class);
