...
namespace Drupal\facets_core_search\Plugin\Search;
...
class NodeSearchFacets extends NodeSearch {
  ...
  public function searchFormAlter(array &$form, FormStateInterface $form_state) {
    ...
    if (\Drupal::config("facets.facet_source.core_node_search__{$this->searchPageId}")->get('third_party_settings.facets_core_search.advanced_filters')) {
      // Add node types.
