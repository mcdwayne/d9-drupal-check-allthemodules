...
namespace Drupal\facets_core_search\Plugin\facets\facet_source;

use Drupal\Core\Database\Connection;
use Drupal\Core\Extension\ModuleHandlerInterface;
use Drupal\Core\Form\FormStateInterface;
use Drupal\facets_core_search\Plugin\CoreSearchFacetSourceInterface;
 ...
 * @FacetsFacetSource(
 *   id = "core_node_search",
 *   deriver = "Drupal\facets_core_search\Plugin\facets\facet_source\CoreNodeSearchFacetSourceDeriver"
 * )
 */
class CoreNodeSearchFacetSource extends FacetSourcePluginBase implements CoreSearchFacetSourceInterface {
   ...
   *
   * @var \Drupal\facets_core_search\FacetsQuery
   */
  ...
  public function getFacetQueryExtender() {
    if (!$this->facetQueryExtender) {
      $this->facetQueryExtender = $this->database
        ...
        ->extend('Drupal\facets_core_search\FacetsQuery');
