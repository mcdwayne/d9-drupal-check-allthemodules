...
namespace Drupal\facets_core_search\Plugin\facets\query_type;
...
class CoreNodeSearchString extends QueryTypePluginBase {
  ...
  public function execute() {
    /** @var \Drupal\facets_core_search\Plugin\CoreSearchFacetSourceInterface $facet_source */
    $facet_source = $this->facet->getFacetSource();
    $query_info = $facet_source->getQueryInfo($this->facet);
    /** @var \Drupal\facets_core_search\FacetsQuery $facet_query */
