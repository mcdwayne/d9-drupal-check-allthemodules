 ...
 * @Healthcheck(
 *  id = "php_errors",
 *  label = @Translation("PHP Errors"),
 *  description = "Checks the database log for PHP errors.",
 *  tags = {
 *   "performance",
 *  }
 * )
 */
class PhpErrors extends HealthcheckPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['window'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Ignore PHP errors older than'),
      '#default_value' => $this->configuration['window'],
      '#field_suffix' => $this->t('seconds'),
      '#size' => 10,
      '#description' => $this->t('PHP errors than this will not be examined by Healthcheck.'),
      '#required' => TRUE,
    ];
    ...
    $form['count'] = [
      ...
      '#size' => 10,
      '#description' => $this->t('The maximum number of PHP errors to expected in the period of time specified above.'),
      '#required' => TRUE,
    ];
