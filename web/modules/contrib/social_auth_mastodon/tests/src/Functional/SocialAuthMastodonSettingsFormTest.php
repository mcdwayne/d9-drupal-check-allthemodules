...
/**
 * Test Social Auth Mastodon settings form.
 *
 * @group social_auth
 *
 * @ingroup social_auth_mastodon
 */
class SocialAuthMastodonSettingsFormTest extends SocialAuthTestBase {
   ...
   * @var array
   */
  public static $modules = ['social_auth_mastodon'];
