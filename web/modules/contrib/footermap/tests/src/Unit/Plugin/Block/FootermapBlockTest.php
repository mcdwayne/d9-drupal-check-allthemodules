...
class FootermapBlockTest extends UnitTestCase {
  ...
  protected function setUp() {
    ...
    $statickMenuLinkProphet = $this->prophesize('\Drupal\Core\Menu\StaticMenuLinkOverridesInterface');
    $staticMenuLinkOverrides = $statickMenuLinkProphet->reveal();
    ...
    $queryFactory = $this->prophesize('\Drupal\Core\Entity\Query\QueryFactory')->reveal();

    $anonymousTreeManipulator = new AnonymousMenuLinkTreeManipulator($accessManager, $account, $queryFactory);

    $this->container = new ContainerBuilder();

    $this->container->set('entity_type.manager', $entityTypeProphet->reveal());
