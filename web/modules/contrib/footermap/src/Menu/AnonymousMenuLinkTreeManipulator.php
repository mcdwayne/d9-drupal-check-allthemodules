...
class AnonymousMenuLinkTreeManipulator {
   ...
   *   The entity.query service for backwards-compatibility.
   */
  public function __construct(AccessManagerInterface $access_manager, AccountInterface $account, QueryFactory $queryFactory) {
