...
abstract class EventEmitter {
   ...
   *   Fully qualified class name of desired event.
   * @param callable $handler
   *   Callback to invoke when event occurs. Observable will pass observed event instance as a handler parameter.
   */
   ...
   *
   * @param \CleverReach\Infrastructure\Utility\Events\Event $event
   *   Event to fire.
   */
