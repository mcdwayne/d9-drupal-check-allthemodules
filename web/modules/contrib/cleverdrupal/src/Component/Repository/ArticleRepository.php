...
class ArticleRepository {
  ...
  /**
   * Gets articles by provided filters. If filters are not set, all nodes (articles) will be returned.
   *
   ...
   */
  public function getFieldsByContentType($typeId = 'node', $contentType) {
