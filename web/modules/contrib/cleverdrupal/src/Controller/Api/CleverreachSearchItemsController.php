...
use DateTime;
use Drupal\cleverreach\Component\Utility\ArticleSearch\SchemaFieldFactory;
...
class CleverreachSearchItemsController extends CleverreachBaseSearchController {
   ...
   *
   * @return \CleverReach\BusinessLogic\Utility\ArticleSearch\SearchResult\SearchResult Result object, containing all information about matched articles.
   */
  private function getSearchResult($contentType, $filter) {
   ...
   * @param int $timestamp
   *
   * @return \DateTime Converted object from timestamp.
   */
   ...
   *
   * @return \Drupal\node\Entity\Node[] List of matching articles in Drupal.
   */
