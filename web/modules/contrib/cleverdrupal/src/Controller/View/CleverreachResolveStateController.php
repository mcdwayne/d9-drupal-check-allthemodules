...
class CleverreachResolveStateController implements ContainerInjectionInterface {
  ...
  protected function getThemePath($resourcePath) {
    return '/' . drupal_get_path('module', 'cleverreach') . "/theme/$resourcePath";
  }
   ...
   */
  protected function getControllerUrl($routeName) {
    return Url::fromRoute("cleverreach.cleverreach.$routeName", [], ['absolute' => TRUE])->toString();
  }
