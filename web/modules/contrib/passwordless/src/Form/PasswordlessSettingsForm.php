...
class PasswordlessSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['passwordless_settings']['passwordless_toggle_sent_page'] = [
      ...
      '#description' => t('Check this box to display the confirmation message on a different page. Uncheck it to display it as a regular Drupal message. @test', ['@test' => \Drupal::l(t('You can also test the confirmation page.'), new Url('passwordless.user_login_sent', [], ['attributes' => ['target' => '_blank']]))]),
