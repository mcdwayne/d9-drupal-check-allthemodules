...
(function ($) {
    ...
    attach: function (context) {
      ...
      switch (step) {
        case 2:
          ...
          var oid = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pid + '-attributes-' + parent + '"]').find('input.form-checkbox').each(function () {
          ...
          if (oid > 0) {
            $('input[name="products[' + pid + '][attributes][' + parent + '][' + oid + ']"]').prop('checked', true);
            $('input[name="products[' + pid + '][attributes][' + parent + '][' + oid + ']"]').change();
        ...
        case 5:
          ...
          var oid = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pid + '-attributes-' + child + '"]').find('input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="products[' + pid + '][attributes][' + child + '][' + oid + ']"]').prop('checked', true);
            $('input[name="products[' + pid + '][attributes][' + child + '][' + oid + ']"]').change();
        ...
        case 8:
          ...
          var oid = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pid + '-attributes-' + grandchild + '"]').find('input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="products[' + pid + '][attributes][' + grandchild + '][' + oid + ']"]').prop('checked', true);
            $('input[name="products[' + pid + '][attributes][' + grandchild + '][' + oid + ']"]').change();
            $('div#results').append('<p>Grandchild option selected</p>');
          }

          var grandchild = getAttributeID('Grandchild');
          var count = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pid + '-attributes-' + grandchild + '"]').find('input.form-checkbox:checked').each(function () {
            count++;
          });
          if (count > 0) {
          ...
          if (oid > 0) {
            $('input[name="products[' + pid + '][attributes][' + parent + '][' + oid + ']"]').prop('checked', false);
            $('input[name="products[' + pid + '][attributes][' + parent + '][' + oid + ']"]').change();
            $('div#results').append('<p>Parent dependent option deselected</p>');
          }
          break;
        ...
        case 14:
          ...
          var count = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pid + '-attributes-' + child + '"]').find('input.form-checkbox:checked').each(function () {
            count++;
          });
          if (count === 0) {
        ...
        case 17:
          ...
          var oid = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pcid + '-attributes-' + parent + '"]').find('input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="products[' + pcid + '][attributes][' + parent + '][' + oid + ']"]').prop('checked', true);
            $('input[name="products[' + pcid + '][attributes][' + parent + '][' + oid + ']"]').change();
            $('div#results').append('<p>Parent dependent option selected</p>');
          }
          break;
        ...
        case 20:
          ...
          var oid = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pcid + '-attributes-' + child + '"]').find('input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="products[' + pcid + '][attributes][' + child + '][' + oid + ']"]').prop('checked', true);
            $('input[name="products[' + pcid + '][attributes][' + child + '][' + oid + ']"]').change();
            $('div#results').append('<p>Child dependent option selected</p>');
          }
          break;
        ...
        case 23:
          ...
          var oid = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pcid + '-attributes-' + grandchild + '"]').find('input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="products[' + pcid + '][attributes][' + grandchild + '][' + oid + ']"]').prop('checked', true);
            $('input[name="products[' + pcid + '][attributes][' + grandchild + '][' + oid + ']"]').change();
            $('div#results').append('<p>Grandchild option selected</p>');
          }

          var grandchild = getAttributeID('Class grandchild');
          var count = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pcid + '-attributes-' + grandchild + '"]').find('input.form-checkbox:checked').each(function () {
            count++;
          });
          if (count > 0) {
            $('div#results').append('<p style="color:green">Grandchild option displayed</p>');
          ...
          if (oid > 0) {
            $('input[name="products[' + pcid + '][attributes][' + parent + '][' + oid + ']"]').prop('checked', false);
            $('input[name="products[' + pcid + '][attributes][' + parent + '][' + oid + ']"]').change();
            $('div#results').append('<p>Parent dependent option deselected</p>');
          }
          break;
        ...
        case 29:
          ...
          var count = 0;
          $('fieldset[data-drupal-selector="edit-products-' + pcid + '-attributes-' + child + '"]').find('input.form-checkbox:checked').each(function () {
            count++;
          });
          if (count === 0) {
            $('div#results').append('<p style="color:green">Child option removed</p>');
  ...
  var getAttributeID = function (label) {
    ...
    $('legend span.fieldset-legend').each(function () {
      if (label === $(this).html()) {
        var attr = $(this).parent().parent().find('div.fieldset-wrapper').find('div.form-checkboxes').attr('id');
        var attribute = attr.split('-');
        aid = attribute[4];
      }
    });
