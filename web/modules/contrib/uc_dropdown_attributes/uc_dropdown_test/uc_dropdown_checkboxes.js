  ...
  Drupal.behaviors.ucDropdownTest = {
    attach: function (context) {
      ...
      if ($(pane).length > 0) {
        ...
        selector = 'fieldset[data-drupal-selector="edit-product-controls-attributes-';
        ...
        prefix = 'attributes';
        selector = 'fieldset[data-drupal-selector="edit-attributes-';
      ...
      switch (step) {
        case 1:
          ...
          var oid = 0;
          $(selector + parent + '"] input.form-checkbox').each(function () {
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + parent + '][' + oid + ']"]').prop('checked', true);
          }
          break;
        ...
        case 2:
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + parent + '][' + oid + ']"]').change();
        ...
        case 5:
          ...
          var oid = 0;
          $(selector + child + '"] input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + child + '][' + oid + ']"]').prop('checked', true);
          }
          var child = getAttributeID('Child', index);
          var oid = 0;
          $(selector + child + '"] input.form-checkbox').each(function () {
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + child + '][' + oid + ']"]').change();
        ...
        case 8:
          ...
          var oid = 0;
          $(selector + grandchild + '"] input.form-checkbox').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + grandchild + '][' + oid + ']"]').prop('checked', true);
          }
          var grandchild = getAttributeID('Grandchild', index);
          var oid = 0;
          $(selector + grandchild + '"] input.form-checkbox').each(function () {
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + grandchild + '][' + oid + ']"]').change();
            $('div#results').append('<p>Grandchild option selected</p>');
          }
          var grandchild = getAttributeID('Grandchild', index);
          var count = 0;
          $(selector + grandchild + '"] input.form-checkbox:checked').each(function () {
            count++;
          });
          if (count > 0) {
          ...
          if (oid > 0) {
            $('input[name="' + prefix + '[' + parent + '][' + oid + ']"]').prop('checked', false);
          }
          var parent = getAttributeID('Parent', index);
        ...
        case 14:
          ...
          var count = 0;
          $(selector + child + '"] input.form-checkbox:checked').each(function () {
            count++;
          });
          if (count === 0) {
