    ...
    attach: function (context) {
      ...
      switch (step) {
        ...
        case 8:
          ...
          var oid = 0;
          $('select[name="products[' + pid + '][attributes][' + grandchild + ']"]').find('option').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('select[name="products[' + pid + '][attributes][' + grandchild + ']"]').val(oid);
            $('select[name="products[' + pid + '][attributes][' + grandchild + ']"]').change();
        ...
        case 23:
          ...
          var oid = 0;
          $('select[name="products[' + pcid + '][attributes][' + grandchild + ']"]').find('option').each(function () {
            if ($.isNumeric(this.value) &&
              (oid === 0 || oid > parseInt(this.value))) {
          ...
          if (oid > 0) {
            $('select[name="products[' + pcid + '][attributes][' + grandchild + ']"]').val(oid);
            $('select[name="products[' + pcid + '][attributes][' + grandchild + ']"]').change();
            $('div#results').append('<p>Grandchild option selected</p>');
          }
