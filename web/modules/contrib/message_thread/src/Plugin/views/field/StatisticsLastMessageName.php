...
/**
 * Field handler to present the name of the last message poster.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("message_last_name")
 */
class StatisticsLastMessageName extends FieldPluginBase {
  ...
  public function query() {
    ...
    $this->uid = $this->query->addField($this->tableAlias, 'last_message_uid');
  }
