 ...
 */
interface ConfigEntityRevisionsTypeInterface extends ConfigEntityInterface, RevisionableEntityBundleInterface {

  /**
   * Determines whether the config_entity_revisions type is locked.
   *
   * @return string|false
   ...
   *
   * @return string
   *   The help information of this config_entity_revisions type.
   */
   ...
   *
   * @return string
   *   The description of this config_entity_revisions type.
   */
