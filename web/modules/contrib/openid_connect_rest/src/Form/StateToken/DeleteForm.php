...
namespace Drupal\openid_connect_rest\Form\StateToken;
...
class DeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete state token %id?', [
      '%id' => $this->entity->id(),
    ]);
  }
  ...
  public function getConfirmText() {
    return $this->t('Delete state token');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.state_token.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('State token %id was deleted.', [
      '%id' => $this->entity->id(),
    ]));
