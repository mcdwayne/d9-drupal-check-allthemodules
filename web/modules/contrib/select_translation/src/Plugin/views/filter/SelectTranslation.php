...
class SelectTranslation extends FilterPluginBase {
  ...
  public function init(ViewExecutable $view, DisplayPluginBase $display, array &$options = NULL) {
    ...
    $this->valueTitle = $this->t('Select translation filter');
  }
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    $form['mode'] = [
      '#type' => 'fieldset',
      '#title' => $this->t('Select translation selection mode'),
      '#collapsible' => FALSE,
      '#collapsed' => FALSE,
    ];
    ...
    $form['default_language_only'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Display default language content *only*, if the currently selected user language is the default site language.'),
      '#description' => $this->t("When you check this option, the order chosen above will be ignored when current language = site default language,
