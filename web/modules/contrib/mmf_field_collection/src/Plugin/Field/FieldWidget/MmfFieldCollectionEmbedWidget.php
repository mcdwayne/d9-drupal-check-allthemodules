...
namespace Drupal\mmf_field_collection\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'mmf_field_collection_embed' widget.
 *
 * @FieldWidget(
 *   id = "mmf_field_collection_embed",
 *   label = @Translation("Embedded MMF"),
 *   field_types = {
 *     "field_collection"
 *   },
 * )
 */
class MmfFieldCollectionEmbedWidget extends FieldCollectionEmbedWidget {

  /**
   * Shows minimum widgets on the node add form.
   *
   * {@inheritdoc}
   */
