...
namespace Drupal\open_connect\Entity\Form;
...
/**
 * Provides a form for deleting open connect entities.
 */
class DeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirectUrl(new Url('entity.open_connect.collection'));
  }
