...
class PaymentHelper
{
  ...
  const PAY_PAGE_URL_DEMO = 'https://test.nordeaconnect.com/pw/payment';
  const SERVER_URL_DEMO = 'https://test.nordeaconnect.com/pw/serverinterface';

  const SERVER_URL_1 = 'https://pay1.nordeaconnect.com/pw/serverinterface';
  const SERVER_URL_2 = 'https://pay2.nordeaconnect.com/pw/serverinterface';
  const SERVER_URL_3 = 'https://pay3.nordeaconnect.com/pw/serverinterface';
