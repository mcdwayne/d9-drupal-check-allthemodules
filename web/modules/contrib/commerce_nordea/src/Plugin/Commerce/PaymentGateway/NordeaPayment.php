...
namespace Drupal\commerce_nordea\Plugin\Commerce\PaymentGateway;
...
use Drupal\commerce_nordea\DependencyInjection\SummaryHelper;
...
/**
 * Provides the Nordea Connect off-site Checkout payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "nordea_payment",
 *   label = @Translation("Nordea Connect (off-site)"),
 *   display_label = @Translation("Nordea Connect"),
 *    forms = {
 *     "offsite-payment" = "Drupal\commerce_nordea\PluginForm\NordeaOffsiteForm",
 *   },
 * )
 */
class NordeaPayment extends OffsitePaymentGatewayBase implements NordeaPaymentInterface
{
  ...
  const BASKET_LIMIT = 48; // Nordea can handle 50 product lines, 48 because also shipping and discount
  ...
  public function defaultConfiguration()
  {
    return [
        ...
        'merchant_agreement_code_test' => 'demo-merchant',
        'key_handling_mode' => 0,
        'keys_directory' => '',
        'shop_private_keyfile' => '',
        'shop_private_keyfile_test' => 'demo-merchant-private.pem',
        'pay_page_public_keyfile' => 'nordea-e-commerce-live-public-key.pem',
        'pay_page_public_keyfile_test' => 'pay-page-public.pem',
        'pay_page_url_1' => 'https://pay1.nordeaconnect.com/pw/payment',
        'pay_page_url_2' => 'https://pay2.nordeaconnect.com/pw/payment',
        'pay_page_url_3' => '',
        'delayed_url' => '',
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state)
  {
    ...
    $path = \Drupal::service('module_handler')->getModule('commerce_nordea')->getPath() . '/assets/templates/configuration_summary.twig';
    $form['summary'] = [
    ...
    $form['merchant_agreement_code'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Nordea Connect production Shop ID'),
      '#description' => $this->t('Nordea Connect production Shop ID'),
    ...
    $form['merchant_agreement_code_test'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Nordea Connect test Shop ID'),
      '#description' => $this->t('Nordea Connect test Shop ID'),
    ...
    $path = \Drupal::service('module_handler')->getModule('commerce_nordea')->getPath() . '/assets/templates/configuration_generate_keys.twig';
    $context['href'] = Url::fromRoute('commerce_nordea.admin.generateKeys');
    ...
    $context['generateTestDesc'] = $this->t('When you generate live keys, you will need to upload the new public key to Nordea Connect portal');
    ...
    $form['shop_private_keyfile'] = [
      ...
      '#description' => $this->t('Filename of shop secret key file generated with Nordea Connect key pair generator') . sprintf(' (%s)', $this->t('Live')),
    ...
    $form['shop_private_keyfile_test'] = [
      ...
      '#description' => $this->t('Filename of shop secret key file generated with Nordea Connect key pair generator') . sprintf(' (%s)', $this->t('Test')),
    ...
    $form['style_code'] = [
      ...
      '#description' => $this->t('Use of custom payment page template needs first to be uploaded and to be approved by Nordea Connect'),
...
//    ];
    ...
    $form['#attached']['library'][] = 'commerce_nordea/nordea_admin';
