  ...
  public function settingsForm(AssetInterface $asset = NULL) {
    ...
    return [
      'remote_url' => [
        ...
        '#description'   => $this->t('Here you can customize your remote URL.<br>See <a href=":url" target="_blank">@link_text</a> to get more details', [':url' => $url, '@link_text' => 'Manual Transformations of Image']),
        '#maxlength'     => 255,
        '#size'          => 120,
