...
/**
 * Reference an IntelligenceBank files using third-party iframe.
 *
 * @EntityBrowserWidget(
 *   id = "intelligencebank_file",
 *   label = @Translation("IntelligenceBank file"),
 *   description = @Translation("Reference an IntelligenceBank files using third-party iframe.")
 * )
 */
