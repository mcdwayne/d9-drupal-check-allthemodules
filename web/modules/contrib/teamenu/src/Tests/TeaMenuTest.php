...
class BlockClassTest extends WebTestBase {
   ...
   * @var array
   */
  public static $modules = array('block', 'teamenu');

  /**
   * Tests the custom CSS classes for blocks.
   */
  public function testTeaMenu() {
    ...
    $edit = array(
      'region' => 'content',
      'third_party_settings[teamenu][enable]' => '1'
    );
    ...
    $this->assertRaw('<div id="block-mainpagecontent" class="teamenu block block-system block-system-main-block">');
    // Assert the custom class in user menu.
    $this->assertRaw('<nav role="navigation" aria-labelledby="block-useraccountmenu-menu" id="block-useraccountmenu"
class="teamenu block block-menu navigation menu--account">');
  }
