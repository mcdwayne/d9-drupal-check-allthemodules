...
use Drupal\migrate_run\Event\MigrateEvents as MigrateRunEvents;
...
class MigrateExecutable extends MigrateExecutableBase {
  ...
  public function __construct(MigrationInterface $migration, MigrateMessageInterface $message, array $options = []) {
    ...
    $this->listeners[MigrateRunEvents::PREPARE_ROW] = [$this, 'onPrepareRow'];
   ...
   * React to a new row.
   *
   * @param \Drupal\migrate_run\Event\MigratePrepareRowEvent $event
