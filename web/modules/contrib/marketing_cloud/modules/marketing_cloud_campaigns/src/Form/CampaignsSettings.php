...
namespace Drupal\marketing_cloud_campaigns\Form;
 ...
 */
class CampaignsSettings extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'marketing_cloud_campaigns_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['marketing_cloud_campaigns.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('marketing_cloud_campaigns.settings');
