...
namespace Drupal\marketing_cloud_data_events\Form;
 ...
 */
class DataEventsSettings extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'marketing_cloud_data_events_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['marketing_cloud_data_events.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('marketing_cloud_data_events.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($definitions as $key => $value) {
      $config->set("definitions.$key.method", $form_state->getValue(
        ['definitions', $key, 'method']
      ));
      $config->set("definitions.$key.endpoint", $form_state->getValue(
        ['definitions', $key, 'endpoint']
      ));
      $config->set("definitions.$key.schema", $form_state->getValue(
