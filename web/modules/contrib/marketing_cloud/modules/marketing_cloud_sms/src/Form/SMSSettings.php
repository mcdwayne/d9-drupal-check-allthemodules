...
namespace Drupal\marketing_cloud_sms\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Configure marketing_cloud_sms settings for this site.
 */
class SMSSettings extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'marketing_cloud_sms_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['marketing_cloud_sms.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('marketing_cloud_sms.settings');
