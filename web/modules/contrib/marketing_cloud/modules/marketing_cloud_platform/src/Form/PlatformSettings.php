...
namespace Drupal\marketing_cloud_platform\Form;
 ...
 */
class PlatformSettings extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'marketing_cloud_platform_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['marketing_cloud_platform.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('marketing_cloud_platform.settings');
