...
namespace Drupal\marketing_cloud_contacts\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Configure marketing_cloud_contacts settings for this site.
 */
class ContactsSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'marketing_cloud_contacts_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['marketing_cloud_contacts.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('marketing_cloud_contacts.settings');
    ...
    foreach ($config->get('definitions') as $key => $value) {
      ...
      $form['definitions'][$key]['endpoint'] = [
        ...
        '#attributes' => ['placeholder' => $this->t('Please enter URI for %endpoint endpoint', ['%endpoint' => $key])],
