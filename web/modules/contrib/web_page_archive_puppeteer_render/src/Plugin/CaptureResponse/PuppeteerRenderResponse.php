...
namespace Drupal\web_page_archive_puppeteer_render\Plugin\CaptureResponse;
 ...
 */
class PuppeteerRenderResponse extends UriCaptureResponse {

  /**
   * {@inheritdoc}
   */
  public static function getId() {
    return 'wpa_puppeteer_render_capture_response';
  }
