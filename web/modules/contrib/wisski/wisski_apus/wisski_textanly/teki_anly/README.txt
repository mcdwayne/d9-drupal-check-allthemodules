...
The person names in default_person*.csv are a compilation of the Wikipedia lists for
...
The contents of fileis default_person*.csv derive from Wikipedia and are thus
