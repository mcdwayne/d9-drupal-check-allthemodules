...
/**
 * @file
 * Contains \Drupal\wisski_iip_image\Plugin\ImageToolkit\Operation\imagemagick\Pyramid.
 */

namespace Drupal\wisski_iip_image\Plugin\ImageToolkit\Operation\imagemagick;
 ...
 *   id = "WisskiIIPImage_pyramid",
 *   toolkit = "imagemagick",
 *   operation = "pyramid",
 *   label = @Translation("Pyramid"),
 *   description = @Translation("Generates a pyramidal derivative.")
 * )
 */
class Pyramid extends ImagemagickImageToolkitOperationBase {
