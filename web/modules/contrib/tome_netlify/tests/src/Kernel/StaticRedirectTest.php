 ...
 *
 * @coversDefaultClass \Drupal\tome_netlify\EventSubscriber\RedirectSubscriber
 * @group legacy
 */
class StaticRedirectTest extends TestBase {
  ...
  public function testRedirect() {
    ...
    $static->requestPath('_redirect:' . $redirect->id());
    $this->assertFileExists("$base_dir/_redirects");
    $this->assertContains('/test http://localhost/node', file_get_contents("$base_dir/_redirects"));
  }
