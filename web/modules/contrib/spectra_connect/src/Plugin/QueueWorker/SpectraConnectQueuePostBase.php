...
/**
 * Class SpectraConnectQueuePostBase.
 *
 * @package Drupal\spectra_connect\Plugin\QueueWorker
 */
abstract class SpectraConnectQueuePostBase extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($item) {
    ...
    SpectraConnectUtilities::spectraPost($connector, $data);
  }
