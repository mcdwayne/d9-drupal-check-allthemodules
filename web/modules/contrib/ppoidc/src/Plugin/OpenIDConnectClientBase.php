...
abstract class OpenIDConnectClientBase extends PluginBase implements OpenIDConnectClientInterface, ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['how_to'] = array(
      '#markup' => t("<a href='https://developer.pixelpin.io/developeraccount.php' target='_blank'>How do i get my Client ID and Client Secret?</a>")
    );
    ...
    $form['notice'] = array(
      '#markup' => t("<p><b>IMPORTANT: </b>After enabling the module and inputting your Client ID and Client Secret, you'll need to place the PixelPin login and registration blocks. A guide on how to do this can be found in our <a href='https://developer.pixelpin.io/drupal8.php#enabling' target='_blank'>Drupal 8 Plugin documentation</a></p>")
    );
    return $form;
  }
