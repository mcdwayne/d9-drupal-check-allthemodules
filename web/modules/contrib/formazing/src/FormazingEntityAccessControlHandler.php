...
/**
 * Access controller for the Formazing entity entity.
 *
 * @see \Drupal\formazing\Entity\FormazingEntity.
 */
class FormazingEntityAccessControlHandler extends EntityAccessControlHandler {
