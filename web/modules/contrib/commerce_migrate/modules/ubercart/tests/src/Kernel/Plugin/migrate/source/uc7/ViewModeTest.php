...
/**
 * Tests D7 Ubercart view mode source plugin.
 *
 * @covers \Drupal\commerce_migrate_ubercart\Plugin\migrate\source\uc7\ViewMode
...
class ViewModeTest extends MigrateSqlSourceTestBase {
  ...
  public function providerSource() {
    ...
    // Test without any fields on a commerce_product entity.
    $tests[1] = $tests[0];
