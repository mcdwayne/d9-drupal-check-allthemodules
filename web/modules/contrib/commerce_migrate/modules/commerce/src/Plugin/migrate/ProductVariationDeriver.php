...
/**
 * Deriver for Commerce 1 product variations.
 */
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    try {
      foreach ($product_variation_types as $row) {
        ...
        $this->fieldDiscovery->addBundleFieldProcesses($migration, 'commerce_product', $product_variation_type);
        $this->derivatives[$product_variation_type] = $migration->getPluginDefinition();
      }
    }
