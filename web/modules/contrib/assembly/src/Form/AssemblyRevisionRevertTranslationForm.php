...
/**
 * Provides a form for reverting a Assembly revision for a single translation.
 *
 * @ingroup assembly
 */
class AssemblyRevisionRevertTranslationForm extends AssemblyRevisionRevertForm {
  ...
  public function getFormId() {
    return 'assembly_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $assembly_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $assembly_revision);
