...
/**
 * Plugin implementation of the 'Entity Reference Multi Render Mode' formatter.
 *
 * @FieldFormatter(
 *   id = "entity_reference_multi_render",
 ...
 * )
 */
class EntityReferenceMultiRender extends EntityReferenceRevisionsEntityFormatter {
