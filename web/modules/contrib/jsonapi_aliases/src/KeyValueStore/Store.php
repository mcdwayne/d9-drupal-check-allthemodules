...
namespace Drupal\jsonapi_aliases\KeyValueStore;
 ...
 */
class Store extends CacheCollector {
  ...
  public function __construct(KeyValueFactoryInterface $key_value_factory, CacheBackendInterface $cache, LockBackendInterface $lock) {
    parent::__construct('jsonapi_aliases', $cache, $lock);
    $this->keyValueStore = $key_value_factory->get('jsonapi_aliases');
  }
