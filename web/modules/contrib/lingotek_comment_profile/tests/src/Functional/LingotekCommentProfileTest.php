...
namespace Drupal\Tests\lingotek_comment_profile\Functional;
 ...
 * @group legacy
 */
class LingotekCommentProfileTest extends LingotekTestBase {
   ...
   * {@inheritdoc}
   */
  public static $modules = ['block', 'comment', 'node', 'lingotek_comment_profile'];
