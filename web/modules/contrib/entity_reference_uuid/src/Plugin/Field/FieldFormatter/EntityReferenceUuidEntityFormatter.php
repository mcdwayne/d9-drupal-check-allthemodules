...
namespace Drupal\entity_reference_uuid\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'entity reference uuid rendered entity' formatter.
 *
 * @FieldFormatter(
 *   id = "entity_reference_uuid_entity_view",
 ...
 * )
 */
class EntityReferenceUuidEntityFormatter extends EntityReferenceUuidFormatterBase implements ContainerFactoryPluginInterface {
