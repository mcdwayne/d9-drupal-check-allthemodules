...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\setka_editor\SetkaEditorUninstallValidator' "modules/custom/setka_editor/src".
 */
...
namespace Drupal\setka_editor\ProxyClass {
    ...
    class SetkaEditorUninstallValidator implements \Drupal\Core\Extension\ModuleUninstallValidatorInterface
    {
         ...
         *
         * @var \Drupal\setka_editor\SetkaEditorUninstallValidator
         */
        protected $service;
