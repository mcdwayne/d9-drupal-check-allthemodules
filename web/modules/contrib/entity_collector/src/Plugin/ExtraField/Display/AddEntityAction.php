 ...
 *
 * @ExtraFieldDisplay(
 *   id = "add_entity_to_entity_collection",
 *   label = @Translation("Add entity to collection."),
 *   deriver = "Drupal\entity_collector\Plugin\Derivative\EntityCollectionActionsDerivative"
 * )
 */
class AddEntityAction extends EntityCollectionActionBase implements ContainerFactoryPluginInterface {
  ...
  protected function getActionLinkTitle(EntityCollectionTypeInterface $entityCollectionType) {
    return $this->t('Add to :label collection', [':label' => $entityCollectionType->label()]);
  }
