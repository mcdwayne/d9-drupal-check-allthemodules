...
/**
 * Provides a form for reverting a Entity collection revision for a single translation.
 *
 * @ingroup entity_collector
 */
class EntityCollectionRevisionRevertTranslationForm extends EntityCollectionRevisionRevertForm {
  ...
  public function getFormId() {
    return 'entity_collection_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $entity_collection_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $entity_collection_revision);
