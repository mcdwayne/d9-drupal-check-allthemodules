 ...
 * Class controller.
 */
class SpamMasterContactController extends ControllerBase {

  protected $form = NULL;
  protected $formstate = NULL;
  protected $spammasterip = NULL;
  protected $spammasteremail = NULL;
  protected $spammastermessage = NULL;

  /**
   * {@inheritdoc}
   */
  public function spammastercontactcheck($form, $formstate, $spammasterip, $spammasteremail, $spammastermessage) {
    $this->form = $form;
    ...
    if ($spammaster_status == 'VALID' || $spammaster_status == 'MALFUNCTION_1' || $spammaster_status == 'MALFUNCTION_2') {
      ...
      if (empty($result_message_content_trim)) {
        $result_message_content_trim = 'your-message';
      }
      ...
      // Web api check.
        ...
        $blog_threat_content = $result_message_content_trim;
