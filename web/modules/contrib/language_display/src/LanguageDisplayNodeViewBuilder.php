...
namespace Drupal\language_display;
...
/**
 * Class LanguageDisplayNodeViewBuilder.
 *
 * @package Drupal\language_display
 */
class LanguageDisplayNodeViewBuilder extends EntityViewBuilder {
  /**
   * {@inheritdoc}
   */
