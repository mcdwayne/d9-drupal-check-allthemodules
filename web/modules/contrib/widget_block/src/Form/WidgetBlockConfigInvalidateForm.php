...
/**
 * @file
 * Contains \Drupal\widget_block\Form\WidgetBlockConfigInvalidateForm.
 */
 ...
 */
class WidgetBlockConfigInvalidateForm extends EntityConfirmFormBase { 
  ...
  public function getQuestion() {
    return $this->t('Do you want to invalidate the widget block markup?');
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['languages'] = [
      ...
      '#description' => $this->t('Select the language which should be invalidated.'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch_definition = [
      'operations' => [],
      'finished' => '_widget_block_batch_invalidate_finished',
    ];
    ...
    foreach ($language_codes as $language_code) {
      ...
      $batch_definition['operations'][] = [
        '_widget_block_batch_invalidate_operation',
        [$widget_block_config, $language_manager->getLanguage($language_code)],
      ];
    }
