 ...
 *
 * @QueueWorker(
 *   id = "advertising_product_provider_004_update",
 *   title = @Translation("Advertising product update for 004"),
 *   cron = {"time" = 60}
 * )
 */
class AdvertisingProduct004Update extends QueueWorkerBase implements ContainerFactoryPluginInterface {
