 ...
 *
 * @QueueWorker(
 *   id = "advertising_product_tracdelight_provider_update",
 *   title = @Translation("Advertising product update for tracdelight products"),
 *   cron = {"time" = 60}
 * )
 */
class AdvertisingProductTracdelightUpdate extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    ...
    // any exception that we get will be logged by the Queue and the item will
    // be released to be tried again later.
    catch (Exception $e) {
      throw $e;
    }
  }
