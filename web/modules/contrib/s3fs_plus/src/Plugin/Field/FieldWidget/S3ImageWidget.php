...
/**
 * Plugin implementation of the 's3fs_plus_image' widget.
 *
 * @FieldWidget(
 *   id = "s3fs_plus_image",
 *   label = @Translation("S3fs Image"),
 *   field_types = {
 *     "image"
 *   }
 * )
 */
class S3ImageWidget extends FileWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    // supported by the current image toolkit.
