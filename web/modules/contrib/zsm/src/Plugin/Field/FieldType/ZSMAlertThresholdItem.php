...
/**
 * Field type "zsm_alert_threshold".
 *
 * @FieldType(
 *   id = "zsm_alert_threshold",
 *   label = @Translation("ZSM: Alert Threshold"),
 *   description = @Translation("Alert Threshold field."),
 *   category = @Translation("ZSM"),
 *   default_widget = "zsm_alert_threshold_default",
 *   default_formatter = "zsm_alert_threshold_default",
 * )
 */
class ZSMAlertThresholdItem extends FieldItemBase implements FieldItemInterface {
    /**
     * {@inheritdoc}
     */
    ...
    public function isEmpty() {
        ...
        if (
            ...
            (isset($item['context']) && !empty($item['context'])) ||
