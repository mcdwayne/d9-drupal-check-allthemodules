...
namespace Drupal\swagger_json_schema;
...
class SchemaFactory {
   ...
   *
   * @return \Drupal\swagger_json_schema\Schema\Schema
  ...
  public function create($entity_type, $bundle = NULL) {
    ...
    if ($entity_type == 'node' && !empty($bundle)) {
      $class = '\Drupal\swagger_json_schema\Schema\NodeSchema';
    }
    else {
      $class = '\Drupal\swagger_json_schema\Schema\Schema';
    }
