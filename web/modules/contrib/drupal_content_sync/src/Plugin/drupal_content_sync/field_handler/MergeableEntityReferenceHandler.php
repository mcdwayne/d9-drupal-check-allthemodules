 ...
 *
 * @FieldHandler(
 *   id = "drupal_content_sync_mergeable_entity_reference_handler",
...
class MergeableEntityReferenceHandler extends DefaultEntityReferenceHandler {
  ...
  public function getHandlerSettings() {
    ...
    if ($this->fieldDefinition->getFieldStorageDefinition()->isMultiple()) {
      $options['merge_local_changes'] = [
        ...
        '#default_value' => isset($this->settings['handler_settings']['merge_local_changes']) && $this->settings['handler_settings']['merge_local_changes'] === 1 ? 1 : 0,
      ];
    }
  ...
  protected function setValues(ImportIntent $intent) {
    ...
    $reference_type = $this->getTargetEntityType($entity);
