 ...
 * Class Mockers.
 *
 * @package Drupal\Tests\cache_consistent
 */
trait Mockers {
  protected $depth = 0;
  ...
  protected function mockContainer() {
    ...
    $checksum_provider = new TestTagsChecksum();
    $container->set('cache.checksum.test', $checksum_provider);
    $container->set('cache.backend.test1', new TestMemoryBackend($checksum_provider));
    $container->set('cache.backend.test2', new MemoryBackend('test'));
    return $container;
  }
