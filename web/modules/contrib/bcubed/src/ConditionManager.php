...
class ConditionManager extends DefaultPluginManager {
  ...
  /**
   * Constructs an ConditionManager object.
   *
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler, StringGenerator $string_generator) {
    parent::__construct('Plugin/bcubed/Condition', $namespaces, $module_handler, 'Drupal\bcubed\ConditionInterface', 'Drupal\bcubed\Annotation\Condition');

    $this->alterInfo('bcubed_conditions_info');
    $this->setCacheBackend($cache_backend, 'bcubed_conditions');
