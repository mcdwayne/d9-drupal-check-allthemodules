...
2. In block list /admin/structure, place the Transcript block in any regions
3. You can see the transcript integrated page.
4. For additional settings, check this
/admin/config/transcript

CONFIGURATION IN YOUTUBE SITE
======================
1. First check, whether you can able to access the transcripts using the Url 
...
2. Note: If the transcript generated automatically by Youtube, we can't fetch. 
