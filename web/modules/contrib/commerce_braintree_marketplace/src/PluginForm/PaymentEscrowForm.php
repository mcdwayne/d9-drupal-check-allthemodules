...
class PaymentEscrowForm extends PaymentGatewayFormBase {

  /**
   * @inheritDoc
   */
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $form['#success_message'] = t('Marketplace payment held in escrow.');
    return $form;
  }
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    $payment_gateway_plugin->holdInEscrow($payment);
  }
