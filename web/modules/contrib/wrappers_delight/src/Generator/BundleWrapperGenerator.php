...
class BundleWrapperGenerator extends WrapperGeneratorBase {
   ...
   * @return bool
   */
  public function generate($entity_type, $bundle, $class_name, $entity_wrapper_class, $extension, $methods) {
    $template = 'class.bundle.php.twig';
   ...
   * @param array $methods
   */
  public function update($entity_type, $bundle, $class_name, $entity_wrapper_class, $extension, $methods) {
