...
/**
 * Provides a confirmation form for processing multiple mail queue items.
 */
class MailEntityQueueItemMultipleProcessConfirmForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'mail_entity_queue_item_multiple_process_confirm';
  }
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to process these items?');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm')) {
      ...
      mail_entity_queue_item_process_batch($items);
    }

    // Clear out the mail queue items from the temp store.
    $this->tempStoreFactory->get('mail_entity_queue_item_operations_process')
