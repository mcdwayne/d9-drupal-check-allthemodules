...
namespace Drupal\flashpoint\Plugin\views\style;
 ...
 *
 * @ViewsStyle(
 *   id = "flashpoint_entity_reference",
 *   title = @Translation("Flashpoint Entity Reference list"),
 ...
 * )
 */
class FlashpointEntityReference extends StylePluginBase {
