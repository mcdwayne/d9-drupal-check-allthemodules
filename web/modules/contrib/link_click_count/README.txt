...
The Link Click Count module allows users to find the number of clicks happened on the
particular link.
 ...
 * Visit that Manage Display page.
   ...
   Go to the appropriate field, for which you have saved the configuration,
