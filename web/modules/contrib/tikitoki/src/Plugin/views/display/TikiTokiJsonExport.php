...
namespace Drupal\tikitoki\Plugin\views\display;
...
/**
 * The plugin that handles Data response callbacks for Tiki Toki.
 *
 * @ingroup views_display_plugins
 *
 * @ViewsDisplay(
 *   id = "tikitoki_json_export",
 *   title = @Translation("Tiki Toki JSON"),
 *   help = @Translation("Create a Tiki Toki JSON export."),
 *   uses_route = TRUE,
 *   admin = @Translation("Tiki Toki JSON"),
 *   returns_response = TRUE
 * )
 */
class TikiTokiJsonExport extends PathPluginBase implements ResponseDisplayPluginInterface {
  ...
  /**
   * Constructs a TikiTokiJsonExport object.
   *
  ...
  protected function defineOptions() {
    ...
    $options['style']['contains']['type']['default'] = 'tikitoki_json';
    $options['row']['contains']['type']['default'] = 'tikitoki_fields';
