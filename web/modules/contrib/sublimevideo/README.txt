...
2. Register at http://sublimevideo.net, choose a plan and enter
...
5. Optional. Can be used and edited the template submlimevideo.tpl.php.
   Here, can be used partially the code generated after clicking the button
   "Get the code" (https://my.sublimevideo.net/sites).
