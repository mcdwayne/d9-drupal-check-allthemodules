...
Celum.AssetPickerConnector = function () {
  ...
  if (buildType == 'minimised') {
    var APP_SCRIPTS = ['assetPickerMerged.min.js']
    var MERGED_SCRIPT = ['assetPickerMerged.min.js'];
  } else {
    // always make sure that the application file is the LAST file loaded!
    var APP_SCRIPTS = ['libs/jquery/jquery.js', 'libs/jquery-ui/jquery-ui.js', 'libs/videojs/video.js', 'libs/angular/angular.js', 'libs/angular/modules/ngDialog.js', 'libs/angular/modules/odataresources.js', 'libs/angular/modules/angular-route.js', 'libs/angular/modules/ui-scroll.js', 'libs/angular/modules/http-auth-interceptor.js', 'libs/angular/modules/ng-scrollbar.js', 'libs/angular/modules/rzslider.js', 'libs/angular/modules/angular-translate.js', 'libs/angular/modules/angular-sanitize.js', 'libs/angular/modules/select.js', 'libs/angular/modules/date.js', 'libs/angular/modules/vjs-video.js', 'assetPicker.js'];

    var MERGED_SCRIPT = ['assetPickerMerged.js'];
  }
  ...
  return {
    ...
    handleMessageEvents: function (event) {
      ...
      if (event.origin === parentOrigin) {
        ...
        if (util.getFrameProperty('id') == data.target) {
