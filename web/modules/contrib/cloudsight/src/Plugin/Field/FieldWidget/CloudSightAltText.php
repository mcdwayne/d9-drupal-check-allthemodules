...
namespace Drupal\cloudsight\Plugin\Field\FieldWidget;
...
use Drupal\cloudsight\CloudsightApiService;

/**
 * Plugin implementation of the 'cloud_sight_alt_text' widget.
 *
 * @FieldWidget(
 *   id = "cloud_sight_alt_text",
 *   label = @Translation("CloudSight Alt Text"),
 *   field_types = {
 *     "image"
 *   }
 * )
 */
class CloudSightAltText extends FileWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if (!empty($default_image['uuid']) && $entity = \Drupal::getContainer()->get('entity.manager')->loadEntityByUuid('file', $default_image['uuid'])) {
  ...
  public static function process($element, FormStateInterface $form_state, $form) {
    ...
    $cloudsight = new CloudsightApiService();
    $cloudsight_alt = '';
    if (!empty($element['#files']) && $element['#preview_image_style']) {
      ...
      $cloudsight_alt = $cloudsight->sendImage($file);
    ...
    $element['alt'] = [
      ...
      '#type' => 'textfield',
      '#default_value' => isset($item['alt']) ? $item['alt'] : $cloudsight_alt,
