...
class FrontendEnvironmentForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $deployment_strategy_allowed_values = [
      ...
      'cron' => $this->t('<strong>On cron</strong>: a deployment will be triggered for this environment at each cron run.'),
    ...
    $form['deployment_strategy'] = [
      ...
      '#default_value' => $entity->getDeploymentStrategy() ? $entity->getDeploymentStrategy() : 'manual',
