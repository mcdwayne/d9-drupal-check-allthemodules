 ...
 *
 * @Block(
 *  id = "centreon_service_status",
 *  admin_label = @Translation("Services status"),
 * )
 */
class CentreonServicesBlock extends BlockBase implements ContainerFactoryPluginInterface {
