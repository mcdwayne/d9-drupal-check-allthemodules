...
namespace Drupal\workflow_moderation\ParamConverter;
...
class EntityRevisionConverter extends EntityConverter {
   ...
   */
  public function __construct(EntityManagerInterface $entity_manager, ModerationInformationInterface $moderationInfo) {
    parent::__construct($entity_manager);
    $this->moderationInformation = $moderationInfo;
  ...
  public function convert($value, $definition, $name, array $defaults) {
    ...
    if ($entity && !$this->moderationInformation->isLatestRevision($entity)) {
