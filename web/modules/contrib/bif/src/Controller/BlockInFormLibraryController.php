 ...
 */
class BlockInFormLibraryController extends ControllerBase {
  /**
   * The block manager.
   *
   ...
   */
  public function listBlocks(Request $request, $entity_type_id) {
    ...
    foreach ($definitions as $plugin_id => $plugin_definition) {
      ...
      $links['add'] = [
        ...
        'url' => Url::fromRoute(sprintf('field_ui.block_in_form_add_%s.form_display', $entity_type_id), ['plugin_id' => $plugin_id, 'block_content_type' => $entity_type_id]),
        'attributes' => [
          'class' => ['use-ajax'],
