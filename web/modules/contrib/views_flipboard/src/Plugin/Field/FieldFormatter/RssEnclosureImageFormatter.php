...
namespace Drupal\views_flipboard\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'rss_enclosure_image' formatter.
 *
 * @FieldFormatter(
 *   id = "rss_enclosure_image",
 *   label = @Translation("RSS Enclosure Image"),
 *   field_types = {
 *     "image"
 *   }
 * )
 */
class RssEnclosureImageFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($files as $delta => $file) {
      ...
      $elements[$delta] = [
        '#theme' => 'rss_enclosure_image_formatter',
        '#item' => $item,
