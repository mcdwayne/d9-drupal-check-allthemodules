...
/**
 * @file
 * Contains Drupal\draggable_blocks\Annotation\Draggable.
 */

namespace Drupal\draggable_blocks\Annotation;
 ...
 *
 * Plugin namespace: Plugin\Draggable
 *
 * @see \Drupal\draggable_blocks\Plugin\Draggable\DraggableInterface
 * @see \Drupal\draggable_blocks\Plugin\Draggable\DraggableBase
 * @see \Drupal\draggable_blocks\Plugin\Draggable\DraggablePluginManager
 * @see plugin_api
 *
 * @Annotation
 */
class Draggable extends Plugin {
  /**
   * The plugin ID.
   *
   * @var string
   ...
   *
   * If specified, then the draggable_blocks module will register the template with
