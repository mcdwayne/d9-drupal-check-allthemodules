...
namespace Drupal\message_thread_history\Plugin\views\filter;
...
/**
 * Filter for new message_threads.
 *
 * @ingroup views_filter_handlers
 *
 * @ViewsFilter("message_thread_history_timestamp")
 */
class MessageThreadHistoryTimestamp extends FilterPluginBase {
  ...
  public function query() {
    ...
    $message_thread = $this->query->ensureTable('message_thread_field_data', $this->relationship);
    ...
    $this->query->addWhereExpression($this->options['group'], "($field IS NULL AND ($message_thread.created > (***CURRENT_TIME*** - $limit))) OR $field < $message_thread.created");
  }
