...
namespace Drupal\waterwheel_json_schema\Normalizer;

use Drupal\Core\Routing\RouteProviderInterface;
use Drupal\waterwheel_json_schema\Schema\SchemaInterface;
use Drupal\waterwheel_json_schema\SchemaUrl;
...
class SchemataSchemaNormalizer extends NormalizerBase {
   ...
   * @var string
   */
  protected $supportedInterfaceOrClass = 'Drupal\waterwheel_json_schema\Schema\SchemaInterface';
  ...
  public function normalize($entity, $format = NULL, array $context = array()) {
    ...
    /* @var $entity \Drupal\waterwheel_json_schema\Schema\SchemaInterface */
    $normalized = [
   ...
   *
   * @param \Drupal\waterwheel_json_schema\Schema\SchemaInterface $entity
