...
namespace Drupal\waterwheel_json_schema\Plugin\Type;
 ...
 *
 * @see \Drupal\waterwheel_json_schema\Annotation\TypeMapper
 * @see \Drupal\waterwheel_json_schema\Plugin\TypeMapperBase
 * @see \Drupal\waterwheel_json_schema\Plugin\TypeMapperInterface
 * @see plugin_api
 */
class TypeMapperPluginManager extends DefaultPluginManager implements FallbackPluginManagerInterface {
  ...
  public function __construct(\Traversable $namespaces, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/json_schema/type_mapper', $namespaces, $module_handler, 'Drupal\waterwheel_json_schema\Plugin\TypeMapperInterface', 'Drupal\waterwheel_json_schema\Annotation\TypeMapper');
  }
