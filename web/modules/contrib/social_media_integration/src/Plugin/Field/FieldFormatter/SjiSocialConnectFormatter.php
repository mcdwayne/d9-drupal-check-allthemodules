...
/**
 * @file
 * Contains \Drupal\sjisocialconnect\Plugin\field\formatter\SjiSocialConnectFormatter.
 */

namespace Drupal\sjisocialconnect\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'sjisocialconnect' formatter.
 *
 * @FieldFormatter(
 *   id = "sjisocialconnect",
 ...
 * )
 */
class SjiSocialConnectFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items) {
    ...
    foreach ($items as $delta => $item) {
      if ($item->entity) {
        ...
        $message = $token_service->replace($item->message, array('node' => $node), array('langcode' => $language_interface->getId()));
        $elements[$delta] = array(
          '#suffix' => '<div id="pa-text" class="field field-type-string-long">' . nl2br(text_summary($message)) . '</div>',
