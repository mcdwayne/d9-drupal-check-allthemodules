...
/**
 * @file
 * Contains \Drupal\sjisocialconnect\Form\SjiSocialConnectSettingsForm.
 */
...
/**
 * Configure Sji Social Connectglobal settings for this site.
 */
class SjiSocialConnectSettingsForm extends ConfigFormBase {
  /**
   * The module handler.
   *
  ...
  public function getFormID() {
    return 'sjisocialconnect_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['sjisocialconnect.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $type = 'new') {
    $config = $this->config('sjisocialconnect.settings');

    if ($widgets = sjisocialconnect_get_widgets()) {
