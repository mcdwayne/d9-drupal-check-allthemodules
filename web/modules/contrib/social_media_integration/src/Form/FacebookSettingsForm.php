...
/**
 * @file
 * Contains \Drupal\sjisocialconnect\FacebookSettingsForm.
 */
...
class FacebookSettingsForm extends ConfigFormBase {
  ...
  public function getFormID() {
    return 'sjisocialconnect_facebook';
  }
  ...
  protected function getEditableConfigNames() {
    return ['sjisocialconnect.facebook'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $type = 'new') {
    $config = $this->config('sjisocialconnect.facebook');
