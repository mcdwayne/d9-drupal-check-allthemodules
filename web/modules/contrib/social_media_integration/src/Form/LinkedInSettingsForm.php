...
/**
 * @file
 * Contains \Drupal\sjisocialconnect\LinkedInSettingsForm.
 */
...
class LinkedInSettingsForm extends ConfigFormBase {
  ...
  public function getFormID() {
    return 'sjisocialconnect_linkedin';
  }
  ...
  protected function getEditableConfigNames() {
    return ['sjisocialconnect.linkedin'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $type = 'new') {
    $config = $this->config('sjisocialconnect.linkedin');
