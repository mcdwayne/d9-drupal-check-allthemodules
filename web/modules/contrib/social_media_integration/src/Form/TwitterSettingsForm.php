...
/**
 * @file
 * Contains \Drupal\sjisocialconnect\TwitterSettingsForm.
 */
...
class TwitterSettingsForm extends ConfigFormBase {
  ...
  public function getFormID() {
    return 'sjisocialconnect_twitter';
  }
  ...
  protected function getEditableConfigNames() {
    return ['sjisocialconnect.twitter'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $type = 'new') {
    $config = $this->config('sjisocialconnect.twitter');
