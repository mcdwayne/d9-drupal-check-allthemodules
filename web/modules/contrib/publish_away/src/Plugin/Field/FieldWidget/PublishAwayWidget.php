...
/**
 * @file
 * Contains \Drupal\publish_away\Plugin\Field\FieldWidget\PublishAwayWidget.
 */

namespace Drupal\publish_away\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'publish_away' widget.
 *
 * @FieldWidget(
 *   id = "publish_away",
 ...
 * )
 */
class PublishAwayWidget extends FileWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    $element['#access'] = \Drupal::currentUser()->hasPermission('use publish away');
    // Providers.
    ...
    foreach (\Drupal::moduleHandler()->getImplementations('publish_away_info') as $module) {
      $publish_away_info = \Drupal::moduleHandler()->invoke($module, 'publish_away_info');
      $options += isset($publish_away_info['providers']) ? $publish_away_info['providers'] : array();
    }
    ...
    $element['#description'] = t('Allowed types: @extensions.',
      array('@extensions' => implode(' ', $element['#upload_validators']['file_validate_extensions'])));
