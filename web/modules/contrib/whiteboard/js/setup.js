**
 * @file
 * Javascript behaviors for Whiteboard
 */ 
...
(function ($, Drupal, document) {
  ...
  /**
   * Attaches behaviors for Whiteboard.
   */
  Drupal.behaviors.whiteboard = {
    attach: function (context, settings) {
      ...
      $('#edit-whiteboard-clear-points').click(function (e) {
        ...
        e.stopPropagation();
        points = new Array();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(pointsCleared).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-clear-board').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(whiteboardCleared).fadeIn(100);});
        });
      ...
      $('#edit-whiteboard-penwidth-fine').click(function (e) {
        ...
        setPenColor();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(penWidthSaved).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-black').click(function (e) {
        ...
        setPenColor();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(penColorSaved).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-eraser').click(function (e) {
        ...
        setPenColor();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(eraserOn).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-cartecian').click(function (e) {
        ...
        setCartecian();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(setCartecianMsg).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-default').click(function (e) {
        ...
        setDefault();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(setDefaultMsg).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-show-range').click(function (e) {
        ...
        showRange();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(setRangeMsg).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-show-grid').click(function (e) {
        ...
        showGrid();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(showGridMsg).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-hide-grid').click(function (e) {
        ...
        hideGrid();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(hideGridMsg).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-arc').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(displayArcForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-arc-cancel').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(cancelArcForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-arc-submit').click(function (e) {
        ...
        drawArc();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(hiddenArcForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-rectangle').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(displayRectangleForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-rectangle-cancel').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(cancelRectangleForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-ellipse').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(displayEllipseForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-ellipse-cancel').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(cancelEllipseForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-ellipse-submit').click(function (e) {
        ...
        drawEllipse();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(hiddenEllipseForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-circle-cancel').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(cancelCircleForm).fadeIn(100);
        });
      });
      ...
      $('#edit-whiteboard-circle-submit').click(function (e) {
        ...
        drawCircle();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(hiddenCircleForm).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-line').click(function (e) {
        ...
        drawLine();
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(drawLineMsg).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-polyline').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(drawPolyline).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-polygon').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(drawPolygon).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-closed-curve').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(drawClosedCurve).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-bezier').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(drawBezierCurve).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-curve').click(function (e) {
        ...
        $('#whiteboard-status').fadeOut(100, function() { 
          $('#whiteboard-status').html(drawCurve).fadeIn(100);
        });
        points = new Array();
      });
      ...
      $('#edit-whiteboard-submit').click(function() {
        $.ajax({
          ...
          dataType: 'json',
          data: {
            message:$('#whiteboard').html(),
            nodeId:Drupal.settings.whiteboard.nodeId 
          },
          success: function() { 
            $('#whiteboard-status').fadeOut(100, function() { 
            $('#whiteboard-status').html(saved).fadeIn(100);}); 
          },
          error: function() {
            $('#whiteboard-status').fadeOut(100, function() { 
              $('#whiteboard-status').html(saveFailed).show(100);
            }); 
          }
        });
      });
      ...
      system = 'default';
      gr.setOrigin(defaultOrigin);
      $('#whiteboard-status').fadeOut(1000, function() { 
        $('#whiteboard-status').html(whiteboardLoaded).fadeIn(1200);
      });
    }
  };
