 ...
 */
class Angularsinglepage extends ControllerBase {
	...
	$events = "My Custom events";
        ...
        return [
        	'#theme' => 'asinglepage_form',
        	'#events' => $events,
			'#attached' =>
			array(
			  'library' =>
				array('examplelist/angular.angularjs','examplelist/angular_singlepage_js.example'),
