...
namespace Drupal\spectra_flat\Plugin\views\field;
 ...
 *
 * @ViewsField("spectra_flat_statement_data_viewer")
 */

class SpectraFlatDataViewerField extends FieldPluginBase {
  /**
   * @{inheritdoc}
   */
  ...
  public function getValue(ResultRow $values, $field = NULL) {
    ...
    $data_m = $data_entity->get('flat_statement_data')->getValue();
