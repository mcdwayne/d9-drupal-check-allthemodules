...
class UiPageTest extends RulesBrowserTestBase {
   ...
   * @var array
   */
  public static $modules = ['rules', 'rules_test', 'tr_rulez'];
  ...
  public function testRuleStatusOperations() {
    ...
    $this->assertSession()->pageTextContains('The reaction rule Test rule has been disabled.');

    // Test enabling.
    $this->clickLink('Enable');
    $this->assertSession()->pageTextContains('The reaction rule Test rule has been enabled.');
  }
