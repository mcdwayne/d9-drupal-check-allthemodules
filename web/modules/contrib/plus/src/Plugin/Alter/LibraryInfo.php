 ...
 * @Alter("library_info")
 */
class LibraryInfo extends ThemePluginBase implements AlterInterface {
  ...
  public function alter(&$libraries, &$extension = NULL, &$context2 = NULL) {
    ...
    if ($extension === 'bootstrap') {
      ...
      $version = $this->theme->getSetting('cdn_' . $provider->getPluginId() . '_version') ?: Plus::FRAMEWORK_VERSION;
