 ...
 */
class ThemeSuggestions extends ThemePluginBase implements AlterInterface {
   ...
   *
   * @var \Drupal\plus\Utility\Variables
   */
  protected $variables;
  ...
  public function alter(&$suggestions, &$variables = [], &$hook = NULL) {
    ...
    $this->variables = new Variables($variables, $this->theme);
