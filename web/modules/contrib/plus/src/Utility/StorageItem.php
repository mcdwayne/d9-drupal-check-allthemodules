...
/**
 * @file
 * Contains \Drupal\plus\Utility\StorageItem.
 */
 ...
 * @ingroup utility
 *
 * @see \Drupal\plus\Utility\Storage
 */
class StorageItem extends MemoryStorage implements \Iterator {
  ...
  /**
   * The \Drupal\plus\Storage instance this item belongs to.
   *
   * @var \Drupal\plus\Utility\Storage
   */
  protected $storage;
