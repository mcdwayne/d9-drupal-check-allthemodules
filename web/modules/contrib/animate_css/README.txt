...
Libraries
Animate in libraries/animate (can be downloaded from https://github.com/daneden/animate.css)
...
1. Download and ADD the library from https://github.com/daneden/animate.css in libraries/animate
