 ...
 */
class GovUKFormErrorHandler extends CoreFormErrorHandler {
  ...
  protected function displayErrorMessages(array $form, FormStateInterface $form_state) {
    ...
    foreach ($errors as $name => $error) {
      ...
      elseif ($is_visible_element && $has_id) {
        $this->messenger->addError($this->l($error, Url::fromRoute('<none>', [], ['fragment' => $form_element['#id'], 'external' => TRUE])));
      }
      else {
