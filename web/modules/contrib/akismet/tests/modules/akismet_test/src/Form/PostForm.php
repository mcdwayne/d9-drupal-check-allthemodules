...
class PostForm extends ContentEntityForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $reset_link = \Drupal::l($this->t('Reset'), Url::fromRoute('akismet_test.views_reset', [], ['query' => $this->getDestinationArray()]));
    $form['views'] = array(
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.akismet_test_post.edit_form', array('akismet_test_post' => $this->entity->id()));
  }
}
