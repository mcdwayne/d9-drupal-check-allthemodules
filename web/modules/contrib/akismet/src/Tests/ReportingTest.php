...
/**
 * Verify that session data is properly stored and content can be reported to Akismet.
 * @group akismet
 */
class ReportingTest extends AkismetTestBase {

  public static $modules = ['dblog', 'akismet', 'node', 'comment', 'akismet_test_server', 'akismet_test', 'views'];
