...
class NodeFormTest extends AkismetTestBase {
  ...
  function testData() {
    ...
    $this->setProtectionUI('node_article_form', FormInterface::AKISMET_MODE_CAPTCHA);
    $this->drupalLogout();
    ...
    $this->assertAkismetData('node', $this->node->id(), 'captchaId', $captchaId);
  }
  ...
  function testRetain() {
    $this->drupalLogin($this->adminUser);
    $this->setProtectionUI('node_article_form', FormInterface::AKISMET_MODE_ANALYSIS, NULL, [
