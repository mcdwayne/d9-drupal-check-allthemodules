...
class UserFormsTest extends AkismetTestBase {
  ...
  function testUserPasswordCaptcha() {
    ...
    $this->drupalGet('admin/config/content/akismet/add-form', ['query' => ['form_id' => 'user_pass']]);
    $this->assertFieldByName('mode', FormInterface::AKISMET_MODE_CAPTCHA);
  ...
  function testUserRegisterCaptcha() {
    ...
    $this->assertFieldByName('mode', FormInterface::AKISMET_MODE_CAPTCHA);
    $this->setProtectionUI('user_register_form', FormInterface::AKISMET_MODE_CAPTCHA);
    $this->drupalLogout();
  ...
  function testUserRegisterAnalysisCaptcha() {
    ...
    $this->drupalLogin($this->adminUser);
    $this->setProtectionUI('user_register_form', FormInterface::AKISMET_MODE_ANALYSIS);
    $this->drupalLogout();
