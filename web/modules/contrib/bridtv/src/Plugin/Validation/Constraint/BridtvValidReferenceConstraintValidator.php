...
/**
 * Checks if referenced entities are valid Brid.TV references.
 */
class BridtvValidReferenceConstraintValidator extends ValidReferenceConstraintValidator {
  ...
  public function validate($value, Constraint $constraint) {
    ...
    foreach ($value as $delta => $item) {
      ...
      if (!$item->isEmpty() && $target_id === NULL && isset($item->entity)) {
