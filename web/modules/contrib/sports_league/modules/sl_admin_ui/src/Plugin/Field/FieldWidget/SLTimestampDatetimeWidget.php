...
namespace Drupal\sl_admin_ui\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'datetime timestamp' widget without default.
 *
 * @FieldWidget(
 *   id = "sl_datetime_timestamp",
 *   label = @Translation("Datetime Timestamp for Sports League"),
 *   field_types = {
 *     "timestamp",
 *     "created",
 *   }
 * )
 */
class SLTimestampDatetimeWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['value']['#description'] = $this->t('Format: %format.', array('%format' => Datetime::formatExample($date_format . ' ' . $time_format)));
