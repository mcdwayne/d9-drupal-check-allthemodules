...
namespace Drupal\usable_json\Plugin\views\display;
 ...
 *
 * @ViewsDisplay(
 *   id = "usable_json_export",
 *   title = @Translation("Usable JSON export"),
 *   help = @Translation("Create a Usable JSON export resource."),
 *   uses_route = FALSE,
 *   admin = @Translation("REST export"),
 *   returns_response = TRUE
 * )
 */
class UsableJSONExport extends DisplayPluginBase implements ResponseDisplayPluginInterface {
