...
class DBQueries{
    ...
    public static function get_user_id($user)
    {
       $user_id = $user->id();
        ...
        /*  $connection = \Drupal::database();
          $query = $connection->query("SELECT * FROM miniorange_oauth_client_token where user_id_val = '$user_id'");
    ...
    {
       /* $connection = \Drupal::database();
        $result = $connection->insert('miniorange_oauth_client_token')
            ->fields([
                'user_id_val' => $user->id(),
                ])
            ->execute();
     ...
     $database->insert('miniorange_oauth_client_token')->fields($fields)->execute();
    }
    public static function update_user_in_table($user)
    {
       // db_update('miniorange_oauth_client_token')
       $connection = \Drupal::database();
       $result = $connection->update('miniorange_oauth_client_token')
       -> fields([
    ...
    public static function insert_code_from_user_id($code, $user)
    {
        $user_id = $user->id();
        $connection = \Drupal::database();
        $num_updated = $connection->update('miniorange_oauth_client_token')
    ...
    public static function get_code_from_user_id($request_code)
    {
        ...
        $connection = \Drupal::database();
        $query = $connection->query("SELECT * FROM miniorange_oauth_client_token where auth_code = '$request_code'");
    ...
    {
       // $authCodeTime = db_update('miniorange_oauth_client_token')
       $user_id = $user->id();
       $connection = \Drupal::database();
       $authCodeTime = $connection->update('miniorange_oauth_client_token')
...
*/
    ...
    {
        $connection = \Drupal::database();
        $access_token_inserted = $connection->update('miniorange_oauth_client_token')
...
/*
      //  $access_token_inserted = db_update('miniorange_oauth_client_token')
      $connection = \Drupal::database();
      $access_token_inserted = $connection->update('miniorange_oauth_client_token')
      ->fields([
    ...
    {
        $connection = \Drupal::database();
        $accessToken_expiry_time_inserted = $connection->update('miniorange_oauth_client_token')
        ->fields(['access_token_request_time'=> $req_time])
        ->condition('user_id_val', $user_id,'=')
        ->execute();

        /*
       // $accessToken_expiry_time_inserted = db_update('miniorange_oauth_client_token')
        $connection = \Drupal::database();
      $accessToken_expiry_time_inserted = $connection->update('miniorange_oauth_client_token')
      ->fields([
    ...
    public static function get_user_id_from_access_token($access_token_received)
    {
        ...
        $connection = \Drupal::database();
        $query = $connection->query("SELECT * FROM miniorange_oauth_client_token where access_token = '$access_token_received'");
        $user_id = $query->fetchAssoc();
