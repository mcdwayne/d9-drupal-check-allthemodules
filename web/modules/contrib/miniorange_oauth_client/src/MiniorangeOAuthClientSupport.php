...
class MiniorangeOAuthClientSupport {
  ...
  /**
	...
	public function sendSupportQuery() {
      ...
      $this->query = '[Drupal 8 OAuth Client Module] ' . $this->query;
      $fields = array (
  ...
  public function sendFeatureRequest() {

    $this->query = '[Drupal 8 OAuth Client Module Feature Request] ' . $this->query;
    $fields = array (
      'company' => $_SERVER['SERVER_NAME'],
      'email' => $this->email,
      'phone' => $this->phone,
