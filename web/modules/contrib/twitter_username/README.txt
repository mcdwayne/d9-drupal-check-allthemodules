...
Author: Opi <http://drupal.org/user/263678>
...
Copy the 'twitter_username' module directory in to your Drupal
/modules directory as usual.

Enable the twitter_username module by navigating to the extend page.
