...
/**
 * Determines access to the contact form edit page.
 *
 * @package Drupal\contact_form_permissions\Access
 */
class ContactEditAccessCheck extends ContactAccessCheckBase {
  ...
  public function access(AccountInterface $account, RouteMatchInterface $route_match) {
    return $this->accessByOperation('edit', $account, $route_match);
  }
