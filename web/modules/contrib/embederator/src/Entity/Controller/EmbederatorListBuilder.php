...
/**
 * Provides a list controller for embederator entity.
 *
 * @ingroup embederator
 */
class EmbederatorListBuilder extends EntityListBuilder {
   ...
   * {@inheritdoc}
   *
   * Building the header and content lines for the embederator list.
   *
  ...
  public function buildHeader() {
    ...
    $header['embed_id'] = $this->t('Embed ID');
