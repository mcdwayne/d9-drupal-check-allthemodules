...
namespace Drupal\kb_h5p\Plugin\views\area;
 ...
 *
 * @ViewsArea("kb_h5p_content_add_button_area")
 */

class KbH5PContentAddButtonArea extends AreaPluginBase {
  /**
   * {@inheritdoc}
   */
  public function render($empty = FALSE)
  {
    if (isset($this->view->args[0])) {
      ...
      $params = ['group' => $arg];
      $params['plugin_id'] = 'group_node:kb_h5p';
      $params['destination'] = $dest;
      $url = new Url('entity.group_content.create_form', $params);
      $link = Link::fromTextAndUrl(t('Add KB H5P Content'), $url);
