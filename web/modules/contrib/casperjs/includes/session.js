...
casper.drupalSignIn = function(user) {
  casper.thenOpen('user', function () {
    ...
    this.click('form#user-login-form #edit-submit');
  });

  casper.waitForSelector('body.user-logged-in').then(function() {
...
casper.drupalBeginSession = function(key) {
  casper.then(function() {
    ...
    this.waitFor(function() {
      return casper.page.addCookie(casper.drupalSessions[key]);
    });
