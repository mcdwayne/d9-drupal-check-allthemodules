...
casper.test.begin('Tests homepage structure', 3, function suite(test) {
  ...
  casper.thenOpen('/', function() {
    ...
    test.assertExists('a.site-branding__logo', 'Header link to the homepage is present.');
    test.assertTextExists('Welcome to Site-Install', 'Welcome message is present.');
  });
