...
namespace Drupal\Tests\social_auth_unsplash\Functional;

use Drupal\Tests\social_auth\Functional\SocialAuthTestBase;

/**
 * Test Social Auth Unsplash settings form.
 *
 * @group social_auth
 *
 * @ingroup social_auth_unsplash
 */
class SocialAuthUnsplashSettingsFormTest extends SocialAuthTestBase {
   ...
   * @var array
   */
  public static $modules = ['social_auth_unsplash'];

  /**
   * {@inheritdoc}
   */
  protected function setUp() {
    $this->module = 'social_auth_unsplash';
