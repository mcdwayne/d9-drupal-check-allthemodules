...
/**
 * Provides routes for Shorthand story entities.
 *
...
class ShorthandStoryHtmlRouteProvider extends AdminHtmlRouteProvider {
    ...
    if ($entity_type->hasLinkTemplate('version-history')) {
      ...
      $route
        ->setDefaults([
          ...
          '_controller' => '\Drupal\shorthand\Controller\ShorthandStoryController::revisionOverview',
        ])
        ->setRequirement('_permission', 'access shorthand story revisions')
  ...
  protected function getRevisionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision')) {
      ...
      $route
        ->setDefaults([
          '_controller' => '\Drupal\shorthand\Controller\ShorthandStoryController::revisionShow',
          '_title_`callback' => '\Drupal\shorthand\Controller\ShorthandStoryController::revisionPageTitle',
        ])
        ->setRequirement('_permission', 'access shorthand story revisions')
        ->setOption('_admin_route', TRUE);
  ...
  protected function getSettingsFormRoute(EntityTypeInterface $entity_type) {
    if (!$entity_type->getBundleEntityType()) {
      ...
      $route
        ->setDefaults([
          '_form' => 'Drupal\shorthand\Form\ShorthandStorySettingsForm',
