...
/**
 * @file
 * Contains \Drupal\Tests\theme_system_sandbox\Unit\RendererTestBase.
 */

namespace Drupal\Tests\theme_system_sandbox\Unit;
...
use Drupal\theme_system_sandbox\Render\Renderer;
use Symfony\Component\DependencyInjection\ContainerBuilder;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\HttpFoundation\RequestStack;

/**
 * Base class for the actual unit tests testing \Drupal\theme_system_sandbox\Render\Renderer.
 */
abstract class RendererTestBase extends UnitTestCase {
   ...
   * The tested renderer.
   *
   * @var \Drupal\theme_system_sandbox\Render\Renderer
   */
  protected $renderer;
