...
/**
 * @file
 * Contains \Drupal\Tests\theme_system_sandbox\Unit\RendererTest.
 */
...
/**
 * @coversDefaultClass \Drupal\theme_system_sandbox\Render\Renderer
 * @group Render
 */
class RendererTest extends RendererTestBase {
  ...
  public function testRenderWithAccessControllerResolved($access) {
    ...
    $build = [
      '#access_callback' => 'Drupal\Tests\theme_system_sandbox\Unit\TestAccessClass::' . $method,
    ];
