...
/**
 * Provides common functionality for the MultilingualForm test classes.
 */
trait MultilingualFormTestTrait {

  /**
   * Create a new Multilingual Form Display.
   *
   ...
   */
  protected function createMFD($entity_type, $bundle, $context, $mode, array $data) {
