 ...
 * Configure module here /admin/config/development/commit_author
...
A: You haven't committed yet. Possibly, the author of commit is you.
   You can disable it here - /admin/config/development/commit_author.
...
A: You can configure it here - /admin/config/development/commit_author.
