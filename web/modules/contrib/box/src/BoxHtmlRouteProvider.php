...
class BoxHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'access box overview')
  ...
  protected function getHistoryRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('version-history')) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view all box revisions')
        ->setOption('_admin_route', TRUE);
  ...
  protected function getRevisionRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_revert')) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'revert all box revisions')
        ->setOption('_admin_route', TRUE);
  ...
  protected function getRevisionDeleteRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_delete')) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'delete all box revisions')
        ->setOption('_admin_route', TRUE);
  ...
  protected function getSettingsFormRoute(EntityTypeInterface $entity_type) {
    if (!$entity_type->getBundleEntityType()) {
      $route = new Route("/admin/structure/box/{$entity_type->id()}/settings");
      $route
        ->setDefaults([
          '_form' => 'Drupal\box\Form\BoxSettingsForm',
