...
/**
 * Tests creating box views with the wizard.
 *
 * @ViewsWizard(
 *   id = "box",
 *   base_table = "box_field_data",
 *   title = @Translation("Content")
 * )
 */
class Box extends WizardPluginBase {
   ...
   * @var string
   */
  protected $createdColumn = 'box_field_data-created';
  ...
  public function getAvailableSorts() {
    ...
    return [
      'box_field_data-title:ASC' => $this->t('Title'),
    ];
  }
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['fields']['title']['table'] = 'box_field_data';
