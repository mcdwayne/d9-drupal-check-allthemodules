...
/**
 * @FieldFormatter(
 *  id = "shrinktheweb_link_plain",
 *  label = @Translation("[ShrinkTheWeb] URL as plain text"),
 *  field_types = {"link"}
 * )
 */
class LinkPlain extends FormatterBase {
  ...
  public function viewElements (FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta] = array(
        '#theme' => 'shrinktheweb_formatter_shrinktheweb_link_plain',
        '#url' => $url,
        '#title' => $title,
        '#image_path' => '',
      );
