...
/**
 * @FieldFormatter(
 *  id = "shrinktheweb_link_short",
 *  label = @Translation("[ShrinkTheWeb] Short as link with title 'Link'"),
 *  field_types = {"link"}
 * )
 */
class LinkShort extends FormatterBase {
  ...
  public function viewElements (FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta] = array(
        '#theme' => 'shrinktheweb_formatter_shrinktheweb_link_short',
        '#url' => $url,
        '#image_path' => '',
      );
