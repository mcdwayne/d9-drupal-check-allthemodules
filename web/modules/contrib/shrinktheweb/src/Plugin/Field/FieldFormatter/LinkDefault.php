...
/**
 * @FieldFormatter(
 *  id = "shrinktheweb_link_default",
 *  label = @Translation("[ShrinkTheWeb] Title as link"),
 *  field_types = {"link"}
 * )
 */
class LinkDefault extends FormatterBase {
  ...
  public function viewElements (FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $elements[$delta] = array(
        '#theme' => 'shrinktheweb_formatter_shrinktheweb_link_default',
        '#url' => $url,
        '#title' => $title,
        '#image_path' => '',
      );
