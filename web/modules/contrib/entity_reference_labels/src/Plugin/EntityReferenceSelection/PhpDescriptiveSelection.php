...
/**
 * Defines an alternative to the default descriptive Entity Reference Selection plugin.
 *
 ...
 */
class PhpDescriptiveSelection extends DefaultDescriptiveSelection {

  /**
   * {@inheritdoc}
   */
  public function getReferenceableEntities($match = NULL, $match_operator = 'CONTAINS', $limit = 0) {
    \Drupal::logger('entity_reference_labels')->info('Using PhpSelection 1');
    ...
    \Drupal::logger('entity_reference_labels')->info('Using PhpSelection 2');
