...
namespace Drupal\micro_site\Plugin\views\field;
 ...
 *
 * @ViewsField("site_name")
 */
class SiteName extends EntityField {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    $form['convert_spaces'] = [
      '#title' => $this->t('Convert spaces in site names to hyphens'),
      '#type' => 'checkbox',
