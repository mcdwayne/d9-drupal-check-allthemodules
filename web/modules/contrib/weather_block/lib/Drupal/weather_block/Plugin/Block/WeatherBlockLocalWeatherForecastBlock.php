...
/**
* @file
* Contains \Drupal\weather_block\Plugin\Block\WeatherBlockLocalWeatherForecastBlock.
*/
...
/**
* Provides a block for the local weather forecast.
*
* @Block(
*   id = "weatherblock_block_local_weather_forecast",
*   admin_label = @Translation("Weather Block - Local Weather Forecast")
* )
*/
class WeatherBlockLocalWeatherForecastBlock extends BlockBase {
  /**
  ...
  public function build() {
    ...
    foreach ($weather_Local->result['forecast'] as $key => $val) {
