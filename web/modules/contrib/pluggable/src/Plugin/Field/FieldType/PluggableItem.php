...
/**
 * Plugin implementation of the 'pluggable_item' field type.
 *
 * @FieldType(
 *   id = "pluggable_item",
 *   label = @Translation("Pluggable"),
 *   description = @Translation("Stores configuration for a plugin."),
 *   category = @Translation("Pluggable"),
 *   default_widget = "pluggable_select",
 *   default_formatter = "pluggable_default",
 *   deriver = "\Drupal\pluggable\Plugin\Field\FieldType\PluggableItemDeriver"
 * )
 */
class PluggableItem extends FieldItemBase implements PluggableItemInterface {
