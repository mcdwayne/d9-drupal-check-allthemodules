...
/**
 * Provides a Kayak widget Block with a selector for hotels and flights.
 *
 * @Block(
 *   id = "kayak_integration",
 *   admin_label = @Translation("Kayak General Block"),
 *   category = @Translation("Kayak Widget"),
 * )
 */
class KayakGeneral extends BlockBase implements ContainerFactoryPluginInterface {
