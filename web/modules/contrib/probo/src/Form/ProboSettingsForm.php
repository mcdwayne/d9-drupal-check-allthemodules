...
class ProboSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['probo_general']['base_url'] = [
      ...
      '#description' => $this->t('The base URL of this web site. Include the sub-directory if needed.'),
      '#maxlength' => 64,
      '#size' => 64,
      '#default_value' => $config->get('base_url'),
      '#weight' => 1,
    ];
    $form['probo_general']['probo_mailcatcher_domain'] = [
      '#type' => 'textfield',
      ...
      '#maxlength' => 64,
      '#size' => 64,
      '#default_value' => $config->get('probo_mailcatcher_domain'),
      '#weight' => 1,
    ];
    $form['probo_general']['probo_solr_domain'] = [
      '#type' => 'textfield',
      ...
      '#maxlength' => 64,
      '#size' => 64,
      '#default_value' => $config->get('probo_solr_domain'),
      '#weight' => 2,
    ];
    ...
    $form['probo_general']['probo_builds_protocol'] = [
      '#type' => 'select',
      ...
      '#default_value' => $config->get('probo_builds_protocol'),
      '#required' => TRUE,
      '#weight' => 4,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('probo.probosettings')
      ...
      ->save();
    $this->config('probo.probosettings')
      ->set('probo_mailcatcher_domain', $form_state->getValue('probo_mailcatcher_domain'))
      ->save();
    $this->config('probo.probosettings')
      ->set('probo_solr_domain', $form_state->getValue('probo_solr_domain'))
      ->save();
    $this->config('probo.probosettings')
      ->set('probo_builds_protocol', $form_state->getValue('probo_builds_protocol'))
      ->save();
    $this->config('probo.probosettings')
