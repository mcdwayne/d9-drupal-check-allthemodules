...
class CalendarEventEmbeddedWidget {
   ...
   * @param \Drupal\calendar_event\CalendarEventInterface[] $calendar_events
   ...
   * @param array $element
   *   The subform element.
   * @param \Drupal\calendar_event\CalendarEventInterface $entity
   ...
   *   The entity type ID.
   * @param \Drupal\calendar_event\CalendarEventInterface $calendar_event
