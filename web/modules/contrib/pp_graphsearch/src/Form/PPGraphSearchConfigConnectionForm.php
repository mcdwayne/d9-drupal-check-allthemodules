...
/**
 * @file
 * Contains \Drupal\pp_graphsearch\Form\PPGraphSearchConfigConnectionForm.
 */
...
class PPGraphSearchConfigConnectionForm extends EntityForm {
  /**
   * {@inheritdoc}
   */
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if (!$is_new) {
      ...
      $form['title'] = array(
        '#type' => 'textfield',
        '#title' => t('Name'),
        '#description' => t('Name of the PoolParty GraphSearch configuration.'),
        '#size' => 35,
        '#maxlength' => 255,
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($is_new) {
      ...
      $entity->set('id', SemanticConnector::createUniqueEntityMachineName('pp_graphsearch', $entity->get('title')));
      \Drupal::messenger()->addMessage(t('PoolParty GraphSearch configuration %title has been created.', array('%title' => $entity->get('title'))));
    }
    else {
      \Drupal::messenger()->addMessage(t('Updated PoolParty GraphSearch configuration %title.',
    ...
    $form_state->setRedirectUrl(Url::fromRoute('entity.pp_graphsearch.edit_config_form', array('pp_graphsearch' => $entity->id())));
  }
