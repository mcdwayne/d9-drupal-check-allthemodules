...
class StaticGeneratorForm extends FormBase {
  ...
  /**
   * Sets the base URL for a given set of server parameters.
   *
   * @todo Should this be handled by the static generator?
   *
   * @param array $server
   *   The server parameters (i.e. $_SERVER).
   * @param string $base_url
   *   The base URL.
   *
   * @return array
   *   The modified server parameters.
   */
  protected function setBaseUrl(array $server, $base_url) {
