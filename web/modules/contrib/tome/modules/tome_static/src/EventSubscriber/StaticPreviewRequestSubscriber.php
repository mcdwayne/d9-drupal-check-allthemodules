...
class StaticPreviewRequestSubscriber implements EventSubscriberInterface {
  ...
  public function onRequest(GetResponseEvent $event) {
    ...
    $exit_message = $this->t('<a style="@style" href=":link">Exit preview</a>', [
      ...
      '@style' => 'position: fixed;top: 0;left: calc(50% - 60px);text-align: center;padding: 10px 20px;background: #00000063;border: 0;border-radius: 0 0 10px 10px;color: white;text-decoration: none;font-size: 13px;font-weight: bold;font-family: "Source Sans Pro","Lucida Grande",Verdana,sans-serif;',
    ]);
