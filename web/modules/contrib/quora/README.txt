...
* Google Custom Search Engine CX ID -
  ...
  To generate Google Custom Search Engine API,
...
Quora Block Configuration:

  DISPLAY OPTIONS:
  Allows to control the display of Quora Questions/Posts in the Block.
