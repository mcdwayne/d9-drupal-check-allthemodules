...
/**
 * Plugin implementation of the 'EmailFieldWidget' widget.
 *
 * @FieldWidget(
 *   id = "form_element_states_email",
 *   label = @Translation("Email with states"),
 *   field_types = {
 *     "email"
 *   }
 * )
 */
class EmailFieldWidget extends EmailDefaultWidget{
