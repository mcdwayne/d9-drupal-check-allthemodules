...
(function ($, Drupal) {
  ...
  Drupal.behaviors.vclForm = {
    attach: function (context, settings) {
      ...
      if (attributes) {
        ...
        //Get the element
        var element = createVisualElement(attributes);
      ...
      //--------------------------------------------------------------------------------
      function createVisualElement(attributes) {
        ...
        if (attributes.container) {
          ...
          var container = $('<div>').addClass('vcl-container');

          // Create a append a child if the swap need one
          if (attributes.createChild){
            var child = createElementChild(attributes);
      ...
      //--------------------------------------------------------------------------------
      //                 Auto Create child of the current element
      //--------------------------------------------------------------------------------
      function createElementChild(attributes) {

        var element;

        switch(attributes.swapId) {
          case "swap_accordion":
            ...
            var newAttributes = {
              ...
              title : "Title",
              swapId : "swap_accritem",
              swapName: "Accordion Element"
            };

            element = createVisualElement(newAttributes);
            break;
  ...
  function makeDragAndDrop() {
    $(".vcl-container").sortable({
      ...
      sort: function(e, ui) {
          $(".vcl-container").sortable( "refreshPositions" );
      }
    });
  }
