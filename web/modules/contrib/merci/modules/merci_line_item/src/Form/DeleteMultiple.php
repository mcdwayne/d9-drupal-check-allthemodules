...
class DeleteMultiple extends ConfirmFormBase {
  ...
  public function __construct(PrivateTempStoreFactory $temp_store_factory, EntityManagerInterface $manager) {
    ...
    $this->storage = $manager->getStorage('merci_line_item');
  }
  ...
  public function getFormId() {
    return 'merci_line_item_multiple_delete_confirm';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $this->nodeInfo = $this->tempStoreFactory->get('merci_line_item_multiple_delete_confirm')->get(\Drupal::currentUser()->id());
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    if ($form_state->getValue('confirm') && !empty($this->nodeInfo)) {
      ...
      $this->tempStoreFactory->get('merci_line_item_multiple_delete_confirm')->delete(\Drupal::currentUser()->id());
    }
