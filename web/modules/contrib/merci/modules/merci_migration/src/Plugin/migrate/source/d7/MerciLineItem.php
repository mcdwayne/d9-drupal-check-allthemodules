 ...
 * )
 */
class MerciLineItem extends FieldableEntity {
  /**
   * The module handler.
   *
...
/**
  ...
  public function query() {
    ...
    $query->join('merci_reservation_detail', 'mrd', 'mrd.merci_placeholder_nid = n.nid');
    $query->addField('mrd', 'nid', 'reservation_nid');
    $query->addField('mrd', 'vid', 'reservation_vid');

    $query->fields('mrd');

    $query->join('merci_reservation', 'mr', 'mr. nid = mrd.nid');
    $query->fields('mr');
  ...
  public function prepareRow(Row $row) {
    ...
    // Get Field API field values.
    $nid = $row->getSourceProperty('reservation_nid');
    $vid = $row->getSourceProperty('reservation_vid');
    foreach (array_keys($this->getFields('node', 'merci_reservation')) as $field) {
      $row->setSourceProperty($field, $this->getFieldValues('node', $field, $nid, $vid));
    }
