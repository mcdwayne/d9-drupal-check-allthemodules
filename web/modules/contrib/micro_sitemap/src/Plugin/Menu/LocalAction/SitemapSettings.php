...
namespace Drupal\micro_sitemap\Plugin\Menu\LocalAction;
...
/**
 * Modifies the 'Sitemap settings' local action to add a query destination.
 */
class SitemapSettings extends LocalActionDefault {
