...
/**
 * Test Social Auth Twitch settings form.
 *
 * @group social_auth
 *
 * @ingroup social_auth_twitch
 */
class SocialAuthTwitchSettingsFormTest extends SocialAuthTestBase {
   ...
   * @var array
   */
  public static $modules = ['social_auth_twitch'];

  /**
   * {@inheritdoc}
   */
  protected function setUp() {
    $this->module = 'social_auth_twitch';
