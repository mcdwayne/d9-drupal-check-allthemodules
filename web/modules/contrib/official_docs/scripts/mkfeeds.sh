...
do
  ...
  php  preprocess.php ../source/$lang ../output/html_feed/$lang fi
  cp ../source/$lang/guides-docinfo.xml ../output/html_feed/$lang
  ...
  asciidoc -d book -b docbook -f std.conf -a docinfo -a lang=$lang $langconf -o ../output/html_feed/$lang/guides.docbook ../output/html_feed/$lang/guides.asciidoc
  ...
  xmlto -m feeds.xsl xhtml -o ../output/html_feed/$lang ../output/html_feed/$lang/guides.docbook
...
php  preprocess.php ../guidelines ../output/html_feed/guidelines fi
