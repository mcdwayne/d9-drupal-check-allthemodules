...
<!-- Put chapters on their own pages, and chunk at chapter level. -->
...
<!-- Set the maximum depth for tables of contents to 1. -->
...
<!-- Override output for tips. Omit text and override class. -->
<xsl:template name="nongraphical.admonition">
  <div>
    <xsl:attribute name="class">note-tip</xsl:attribute>
    <xsl:apply-templates/>
  </div>
</xsl:template>
