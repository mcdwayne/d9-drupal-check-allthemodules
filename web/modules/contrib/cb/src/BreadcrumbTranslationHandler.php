...
/**
 * Defines the translation handler for breadcrumbs.
 */
class BreadcrumbTranslationHandler extends ContentTranslationHandler {
  ...
  /**
   * Form submission handler for BreadcrumbTranslationHandler::entityFormAlter().
   *
