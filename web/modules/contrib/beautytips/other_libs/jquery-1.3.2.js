            ...
            if (events[type]) {
              ...
              if (handler) {
                ...
                for (var handle in events[type])
                    // Handle the removal of namespaced events {if
                    // (namespace.test(events[type][handle].type)){delete
                    // events[type][handle];
                    }
...
// Attach a bunch of functions for handling common AJAX events
  ...
  jQuery.extend({
    ...
    ajaxSettings: {
      ...
      // it is available This function can be overriden by calling
      // jQuery.ajaxSetup
      xhr: function () {
...
// Generate shortcuts for custom animations
  ...
  if (document.documentElement["getBoundingClientRect"]) {
    jQuery.fn.offset = function () {
      ...
      var box = this[0].getBoundingClientRect(), doc = this[0].ownerDocument,
