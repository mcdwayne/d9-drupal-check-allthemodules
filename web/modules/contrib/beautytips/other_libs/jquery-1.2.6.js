...
// Will speed up references to undefined, and allows munging its name.
  ...
  jQuery.fn = jQuery.prototype = {
    ...
    clone: function (events) {
      ...
      // this is primarily for IE but the data expando shouldn't be copied over
      // in any browser
...
// Give the init function the jQuery prototype for later instantiation
  ...
  jQuery.extend = jQuery.fn.extend = function () {
        ...
        // Only deal with non-null/undefined values
    {
      ...
      // Extend the base object {for (var name in options) {
  ...
  jQuery.extend({
    ...
    curCSS: function (elem, name, force) {
      ...
      // Opera sometimes will give the wrong display answer, this fixes it, see
      // #2037
            ...
            if (events[type]) {
              ...
              if (handler) {
                ...
                for (handler in events[type])
                    // Handle the removal of namespaced events {if (!parts[1]
                    // || events[type][handler].type == parts[1]){delete
                    // events[type][handler];
                    }
...
// Attach a bunch of functions for handling common AJAX events
  ...
  jQuery.extend({
    ...
    httpSuccess: function (xhr) {
      try {
        // IE error sometimes returns 1223 when it should be 204 so treat it as
        // success, see #1450
    ...
    param: function (a) {
      ...
      // Serialize the key/values
      {
        for (var j in a)
            ...
            // {if (a[j] && a[j].constructor == Array){jQuery.each(a[j],
            // function () {
      ...
      this.each(function () {
        ...
        for (var i = timers.length - 1; i >= 0; i--) {
          if (timers[i].elem == this) {
            if (gotoEnd)
            // force the next step to be the last {timers[i](true);
                }
          timers.splice(i, 1);
        }
      });
    ...
    if (elem) {
      with (jQuery.browser) {
        ...
        if (elem.getBoundingClientRect) {
          ...
          // is 2px IE 6 and 7 quirks mode the border width is overwritable by
          // the following css html { border: 0; } IE 7 standards mode, the
          // border is always 2px This border/offset is typically represented
          // by the clientLeft and clientTop properties However, in IE6 and 7
          // quirks mode the clientLeft and clientTop properties are not
          // updated when overwriting it via CSS
          ...
          while (parent && parent.tagName && !/^body|html$/i.test(parent.tagName)) {
            ...
            // Subtract parent scroll offsets {add(-parent.scrollLeft, -parent.scrollTop);
                }
