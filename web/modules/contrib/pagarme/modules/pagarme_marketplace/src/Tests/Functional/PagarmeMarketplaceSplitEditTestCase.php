...
/**
 * Tests the split edit functionality.
 *
 * @group pagarme_marketplace
 */
class PagarmeMarketplaceSplitEditTestCase extends PagarmeMarketplaceTestCase {
  /**
  ...
  public static function getInfo() {
    return array(
      'name' => 'Split edit',
      'description' => 'Create a split and test split edit functionality.',
  ...
  /**
   * Checks split edit functionality.
   */
  public function testSplitEdit() {
    ...
    $edit = $data_split;
    $edit['split_type'] = 'percentage';
    $edit['default_amount'] = 100;
    $this->drupalGet('admin/commerce/config/marketplace/'. $this->api_key .'/splits/edit/'. $variation_id .'/' . $split_id);
    $this->submitForm($edit, t('Save rule'));
    $this->assertSession()->responseContains(t('Split rule saved.'));
  }
}