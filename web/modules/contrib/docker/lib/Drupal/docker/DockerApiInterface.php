...
/**
 * @file
 * Definition of Drupal\docker\DockerApiInterface.
 */

namespace Drupal\docker;

interface DockerApiInterface {
   ...
   */
  public function containers($all = FALSE, $limit = NULL, $since = NULL, $before = NULL, $size = NULL);
