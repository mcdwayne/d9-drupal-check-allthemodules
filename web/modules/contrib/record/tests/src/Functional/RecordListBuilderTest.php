...
namespace Drupal\Tests\record\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Tests for record list builder.
 *
 * @group Record
 */
class RecordListBuilderTest extends BrowserTestBase {
   ...
   */
  public function testRecordOverview() {
    ...
    $this->drupalGet($list_path);
    // Record name should not be a link as the user doesn't have access to the
    // submission page.
    $assert_session->linkExists('Test: Submissions');
    $assert_session->linkExists('Submissions');
    $assert_session->linkExists('Download');
