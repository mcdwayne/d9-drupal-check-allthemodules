...
/**
 * @file
 * Contains \Drupal\ape\Form\SettingsForm
 */
...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['page_caching']['pages']['#title'] = t('Pages to exclude from caching');
    ...
    $form['page_caching_alternative']['pages']['#title'] = t('Pages that should apply alternative cache length');
