...
/**
 * Implements \Drupal\Core\ParamConverter\ParamConverterInterface for
 * integration-based route parameter converters.
 */
trait IntegrationBasedConverterTrait {
   ...
   */
  public function __construct(IntegrationManagerInterface $integration_manager) {
