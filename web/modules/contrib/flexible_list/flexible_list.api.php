...
/**
 * @file
 * Hooks provided by the Flexible List module.
 */
 ...
 *
 * @ingroup hooks
 * @see hook_flexible_list()
 */
function hook_flexible_list_alter(array &$options, array $context) {
...
/**
 * Provide the allowed values for a 'flexible_list_*' field.
 *
 * Callback for flexible_list_allowed_values().
 *
 * 'flexible_list_*' fields can specify a callback to define the set of their allowed
 * values using the 'allowed_values_*_function' field setting.
 *
 ...
 *   (optional) The field item context if known, or NULL if the allowed values are
 ...
 *
 * @ingroup callbacks
 * @see flexible_list_allowed_values()
 * @see flexible_list_test_allowed_values_callback()
 * @see flexible_list_test_dynamic_values_callback()
 */
function callback_allowed_values_LIST_function(FieldStorageDefinitionInterface $definition, FieldItemInterface $field_item = NULL, &$cacheable = TRUE) {
