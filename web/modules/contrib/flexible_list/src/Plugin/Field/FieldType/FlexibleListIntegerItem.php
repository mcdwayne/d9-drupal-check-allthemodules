...
/**
 * Plugin implementation of the 'flexible_list_integer' field type.
 *
 * @FieldType(
 *   id = "flexible_list_integer",
 *   label = @Translation("Flexible list (integer)"),
 ...
 * )
 */
class FlexibleListIntegerItem extends FlexibleListItemBase {
