...
/**
 * Form for convert text to lowercase.
 */
class ConverterToolsTextToLowercaseForm extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'converter_tools_text_lowercase';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['converter_tools_text'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Converter Text to Lowercase'),
      '#rows' => 20,
      '#cols' => 100,
    ];
