...
2. Download and unpack the Openstat module directory in your modules folder
   ...
   install/modules-themes/modules-8 for addition information.
...
2. If you have chosen "Counter with image" go to Structure -> Block layout page
...
2. Скачайте и распакуйте папку с модулем Openstat в вашу директорию с
   ...
   mentation/install/modules-themes/modules-8 для дополнительной информации.
...
2. Перейдите на страницу Структура -> Расположение блоков
   (admin/structure/block) и установите блок "Счетчик Openstat" в любой регион.
