...
/**
 * Class ConfirmHamForm.
 *
 * @package Drupal\ssf_comment\Form
 */
class ConfirmHamForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'ssf_confirm_ham_comment';
  }
  ...
  public function getQuestion() {
    return $this->t('Do you want to set this comment as ham and publish it?');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger->addStatus($this->t('The comment "@title" has been published.', ['@title' => $comment->getSubject()]));
