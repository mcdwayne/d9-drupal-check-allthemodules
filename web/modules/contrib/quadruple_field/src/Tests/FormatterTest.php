...
namespace Drupal\quadruple_field\Tests;

/**
 * Tests quadruple field formatters.
 *
 * @group quadruple_field
 */
class FormatterTest extends TestBase {
  ...
  public function testFormatterOutput() {
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//div[@class='quadruple-field-accordion']/h3)[$index]/a",
        "(//div[@class='quadruple-field-accordion']/div)[$index]",
      ];
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//div[@class='quadruple-field-tabs']/ul/li)[$index]/a[@href='#quadruple-field-tab-$delta']",
        "(//div[@class='quadruple-field-tabs']/div[@id='quadruple-field-tab-$delta'])",
      ];
      $this->assertFieldValues($axes, $delta);
    }
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//table[contains(@class, 'quadruple-field-table')]/tbody/tr)[$index]/td[2]",
        "(//table[contains(@class, 'quadruple-field-table')]/tbody/tr)[$index]/td[3]",
      ];
      $this->assertFieldValues($axes, $delta);
    }

    $table_header = $this->xpath('//table[contains(@class, "quadruple-field-table")]/thead/tr');
    ...
    $table_header = $this->xpath('//table[contains(@class, "quadruple-field-table")]/thead');
    ...
    $element = $this->xpath('(//table[contains(@class, "quadruple-field-table")]/tbody/tr)[1]/td[2]/text()');
    $this->assertFalse(isset($element[0]), 'First item was not found.');

    $element = $this->xpath('(//table[contains(@class, "quadruple-field-table")]/tbody/tr)[1]/td[3]/text()');
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      ...
      // individually.
      $summary = $this->xpath("(//details[contains(@class, 'quadruple-field-details') and @open])[$index]/summary");
      ...
      $details_wrapper = $this->xpath("(//details[contains(@class, 'quadruple-field-details')])[$index]/div[@class='details-wrapper']");
    ...
    $this->saveFormatterSettings('details', $settings);
    $this->drupalGet($node_path);
    $summary = $this->xpath("//details[contains(@class, 'quadruple-field-details')]")[0];
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//ul[@class='quadruple-field-list']/li[@class='container-inline']/div[@class='quadruple-field-first'])[$index]",
        "(//ul[@class='quadruple-field-list']/li[@class='container-inline']/div[@class='quadruple-field-second'])[$index]",
      ];
      $this->assertFieldValues($axes, $delta);
    }
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//ol[@class='quadruple-field-list']/li[@class='container-inline']/div[@class='quadruple-field-first'])[$index]",
        "(//ol[@class='quadruple-field-list']/li[@class='container-inline']/div[@class='quadruple-field-second'])[$index]",
      ];
      $this->assertFieldValues($axes, $delta);
    }
    ...
    $li_element = $this->xpath('//ol[@class="quadruple-field-list"]/li')[0];
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//dl[@class='quadruple-field-definition-list']/dt)[$index]",
        "(//dl[@class='quadruple-field-definition-list']/dd)[$index]",
      ];
      $this->assertFieldValues($axes, $delta);
    }
    ...
    for ($delta = 0; $delta < self::CARDINALITY; $delta++) {
      $index = $delta + 1;
      $axes = [
        "(//div[contains(@class, 'quadruple-field-unformatted-list')]/div[contains(@class, 'container-inline')])[$index]/div[@class='quadruple-field-first']",
        "(//div[contains(@class, 'quadruple-field-unformatted-list')]/div[contains(@class, 'container-inline')])[$index]/div[@class='quadruple-field-second']",
      ];
      $this->assertFieldValues($axes, $delta);
    }
    ...
    $element = $this->xpath('//div[contains(@class, "quadruple-field-unformatted-list")]/div[contains(@class, "container-inline")]');
    ...
    $element = $this->xpath('(//div[contains(@class, "quadruple-field-unformatted-list")]/div)[1]/div[@class="quadruple-field-first"]');
    $this->assertFalse(isset($element[0]), 'First item was not found.');

    $element = $this->xpath('(//div[contains(@class, "quadruple-field-unformatted-list")]/div)[1]/div[@class="quadruple-field-second"]');
    $this->assertTrue(isset($element[0]), 'Second item was found.');
    ...
    $this->drupalPostForm($this->nodeAddPath, $edit, t('Save'));
    $axes = [];
    $axes[] = '(//div[contains(@class, "quadruple-field-unformatted-list")]/div)[1]/div[@class="quadruple-field-first"]/a[@href="mailto:abc@example.com" and text()="abc@example.com"]';
    $axes[] = '(//div[contains(@class, "quadruple-field-unformatted-list")]/div)[1]/div[@class="quadruple-field-second"]/a[@href="tel:123456789" and text()="123456789"]';
    ...
    $this->drupalPostForm($this->nodeAddPath, $edit, t('Save'));
    $dates = $this->xpath('(//div[contains(@class, "quadruple-field-unformatted-list")]/div)[1]//time');
  ...
  public function testBooleanLabels() {
    ...
    $axes = [
      "//div[contains(@class, 'quadruple-field-unformatted-list')]//div[@class='quadruple-field-first']",
      "//div[contains(@class, 'quadruple-field-unformatted-list')]//div[@class='quadruple-field-second']",
    ];
