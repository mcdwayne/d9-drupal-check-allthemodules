...
use Drupal\quadruple_field\Plugin\Field\FieldFormatter\Base as BaseFormatter;
use Drupal\quadruple_field\Plugin\Field\FieldWidget\QuadrupleField;
...
abstract class TestBase extends WebTestBase {
  ...
  protected function saveWidgetSettings(array $settings) {
    ...
    $options = [
      'type' => 'quadruple_field',
      'weight' => 100,
      'settings' => NestedArray::mergeDeep(QuadrupleField::defaultSettings(), $settings),
  ...
  protected function saveFormatterSettings($formatter, array $settings = []) {
    ...
    $options = [
      'label' => 'hidden',
      'type' => 'quadruple_field_' . $formatter,
      'weight' => 100,
