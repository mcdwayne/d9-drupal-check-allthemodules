...
namespace Drupal\quadruple_field\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'quadruple_field' field type.
 *
 * @FieldType(
 *   id = "quadruple_field",
 *   label = @Translation("Quadruple field"),
 *   description = @Translation("Quadruple field."),
 *   default_widget = "quadruple_field",
 *   default_formatter = "quadruple_field_unformatted_list"
 * )
 */
class QuadrupleField extends FieldItemBase {
    ...
    foreach (['first', 'second', 'third', 'fourth'] as $subfield) {
      ...
      if (static::isListAllowed($type)) {
        ...
        $element[$subfield]['allowed_values'] = [
          ...
          // @see: QuadrupleField::validateAllowedValues()
          '#storage_type' => $type,
