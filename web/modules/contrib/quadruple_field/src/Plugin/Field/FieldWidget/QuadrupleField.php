...
namespace Drupal\quadruple_field\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'quadruple_field' widget.
 *
 * @FieldWidget(
 *   id = "quadruple_field",
 ...
 * )
 */
class QuadrupleField extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $widget = [
      ...
      '#attributes' => ['class' => ['quadruple-field-elements']],
    ];
        ...
        case 'datetime':
          if ($widget[$subfield]['#default_value']) {
            ...
            $widget[$subfield]['#default_value'] = DrupalDateTime::createFromFormat(
              ...
              QuadrupleFieldItem::DATETIME_STORAGE_TIMEZONE
            );
          }
  ...
  protected function getFieldSettings() {
    ...
    foreach (['first', 'second', 'third', 'fourth'] as $subfield) {
      ...
      if ($field_settings[$subfield]['list'] && !QuadrupleFieldItem::isListAllowed($subfield_type)) {
