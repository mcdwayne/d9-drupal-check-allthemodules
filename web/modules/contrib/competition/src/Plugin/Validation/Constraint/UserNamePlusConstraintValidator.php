...
/**
 * Validates the UserNamePlus constraint.
 *
 * @see competition_entity_base_field_info_alter()
 */
class UserNamePlusConstraintValidator extends ConstraintValidator {
  ...
  public function validate($items, Constraint $constraint) {
    ...
    // Here is the only change: inclusion of '+' in the regex.
