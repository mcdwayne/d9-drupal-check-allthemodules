...
/**
 * @file
 * Contains \Drupal\redhen_asset\AssetHtmlRouteProvider.
 */
...
class AssetHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view active asset entities+view inactive asset entities')
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\redhen_asset\Controller\AssetAddController::addForm',
          '_title_callback' => 'Drupal\redhen_asset\Controller\AssetAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\redhen_asset\Controller\AssetAddController::add',
