 ...
 *
 * @package Drupal\file_utility\Form
 * @ingroup content_entity_file_utility
 */
class FileUtilitySettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['allowed_extensions'] = [
      ...
      '#description' => $this->t('Comma seprated file extension on which popup form works ex : pdf, txt, xls, xlsx, doc, docx, ppt, pptx, jpeg, png, gif'),
      '#size' => 64,
    ...
    $form['form_title'] = [
      ...
      '#description' => $this->t('Set form display name leave blank for none'),
      '#size' => 64,
