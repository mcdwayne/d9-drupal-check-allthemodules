...
class TrustpayForm extends BasePaymentOffsiteForm {

  const REDIRECT_URL_TEST = 'https://playground.trustpay.eu/mapi/pay.aspx';
  const REDIRECT_URL_LIVE = 'https://ib.trustpay.eu/mapi/pay.aspx';
