 ...
 *
 * @Action(
 *   id = "entity_gallery_assign_owner_action",
 *   label = @Translation("Change the author of content"),
 *   type = "entity_gallery"
 * )
 */
class AssignOwnerEntityGallery extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new AssignOwnerEntityGallery action.
   *
