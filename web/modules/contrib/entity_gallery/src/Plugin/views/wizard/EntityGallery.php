...
/**
 * Tests creating entity gallery views with the wizard.
 *
 * @ViewsWizard(
 *   id = "entity_gallery",
 ...
 * )
 */
class EntityGallery extends WizardPluginBase {

  /**
   * Set the created column.
   */
  protected $createdColumn = 'entity_gallery_field_data-created';
  ...
  public function getAvailableSorts() {
    ...
    return array(
      'entity_gallery_field_data-title:ASC' => $this->t('Title')
    );
  }
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['fields']['title']['table'] = 'entity_gallery_field_data';
  ...
  protected  function display_options_row(&$display_options, $row_plugin, $row_options) {
    switch ($row_plugin) {
      case 'full_posts':
        $display_options['row']['type'] = 'entity:entity_gallery';
