...
namespace Drupal\entity_gallery\Plugin\views\wizard;
 ...
 *
 * @ViewsWizard(
 *   id = "entity_gallery_revision",
 *   base_table = "entity_gallery_field_revision",
 *   title = @Translation("Content revisions")
 * )
 */
class EntityGalleryRevision extends WizardPluginBase {
  ...
  protected $filters = array(
    'status' => array(
      'value' => TRUE,
      'table' => 'entity_gallery_field_revision',
      'field' => 'status',
      'plugin_id' => 'boolean',
   ...
   *
   * Entity gallery revisions do not support full posts or teasers, so remove
   * them.
   */
  ...
  protected function defaultDisplayOptions() {
    ...
    $display_options['fields']['changed']['table'] = 'entity_gallery_field_revision';
    $display_options['fields']['changed']['field'] = 'changed';
    $display_options['fields']['changed']['entity_type'] = 'entity_gallery';
    ...
    $display_options['fields']['title']['table'] = 'entity_gallery_field_revision';
    $display_options['fields']['title']['field'] = 'title';
    $display_options['fields']['title']['entity_type'] = 'entity_gallery';
