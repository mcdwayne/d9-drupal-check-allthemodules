...
/**
 * Defines a class to build a listing of entity gallery entities.
 *
 * @see \Drupal\entity_gallery\Entity\EntityGallery
 */
class EntityGalleryListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new EntityGalleryListBuilder object.
   *
  ...
  public function buildRow(EntityInterface $entity) {
    ...
    $mark = array(
      '#theme' => 'mark',
      '#mark_type' => entity_gallery_mark($entity->id(), $entity->getChangedTime()),
    );
    ...
    $row['type'] = entity_gallery_get_type_label($entity);
