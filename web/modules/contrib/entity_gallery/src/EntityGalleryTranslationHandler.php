...
/**
 * Defines the translation handler for entity galleries.
 */
class EntityGalleryTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      $form['content_translation'] += array(
        '#group' => 'advanced',
        '#attributes' => array(
          'class' => array('entity-gallery-translation-options'),
        ),
      );

      $form['content_translation']['#weight'] = 100;

      // We do not need to show these values on entity gallery forms: they
      // inherit the basic entity gallery property values.
