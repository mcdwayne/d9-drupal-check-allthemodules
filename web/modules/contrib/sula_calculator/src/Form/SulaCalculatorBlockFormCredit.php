 ...
 */
class SulaCalculatorBlockFormCredit extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'sula_calculator_form_credit';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $acad_year = $sula_config->get('acad_year_length_credit');
    ...
    $form['calculation-message']['#suffix'] = '<div class="col-md-12 calculator calculate-message sula-credit-message"></div>';
  ...
  public function calculateAjax(array &$form, FormStateInterface $form_state) {
    ...
    if (isset($form['prog_length']['#value']) && isset($form['year_length']['#value'])) {
      ...
      $sula = round($sula, 2);
      if ($prog_length !== 0) {
        $response->addCommand(new HtmlCommand('.sula-credit-message', 'Your maximum SULA Eligibility is ' . $sula . " years."));
      }
    }
