...
class Query extends QueryBase implements QueryInterface {
   ...
   */
  public function __construct(EntityTypeInterface $entity_type, $conjunction, array $namespaces, PluginManagerInterface $storage_client_manager, ResponseDecoderFactoryInterface $decoder, ClientInterface $http_client, EntityTypeManagerInterface $entity_type_manager) {
   ...
   *
   * @return int
   *   The amount of bundles.
   */
  protected function amountOfBundleConditions(ConditionInterface $condition = NULL) {
    $amount = 0;
    if (is_null($condition)) {
      $condition = $this->condition;
    }
   ...
   *
   * @return string|bool
   *   The bundle id, FALSE if not found.
   */
