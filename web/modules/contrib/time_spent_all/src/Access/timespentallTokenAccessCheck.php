...
/**
 * @file
 * Contains \Drupal\time_spent_all\Access\timespentTokenAccessCheck.
 */

namespace Drupal\time_spent_all\Access;
 ...
 */
class timespentallTokenAccessCheck implements AccessInterface {
  /**
