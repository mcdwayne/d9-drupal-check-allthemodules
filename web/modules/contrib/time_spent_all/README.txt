...
- Module creates the path - admin/reports/time_spent_all/timespentall-list-users which lists all the users along with the total time spent by them in tabular format.
- Path admin/reports/time_spent_all/timespentall-list-users has autocomplete user search textfield which helps you in getting the complete report of that user.
