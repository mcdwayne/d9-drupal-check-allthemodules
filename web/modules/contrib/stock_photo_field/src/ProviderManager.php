...
class ProviderManager extends DefaultPluginManager implements ProviderManagerInterface, MapperInterface {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/stock_photo_field/Provider', $namespaces, $module_handler, 'Drupal\stock_photo_field\ProviderPluginInterface', 'Drupal\stock_photo_field\Annotation\StockPhotoProvider');
    $this->alterInfo('stock_photo_field_provider_info');
  }
