...
namespace Drupal\stock_photo_field\Plugin\Field\FieldFormatter;
 ...
 *
 * @FieldFormatter(
 *   id = "stock_photo_field_image_formatter",
 ...
 * )
 */
class StockPhotoImageFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      if (!$provider) {
        $element[$delta] = ['#theme' => 'stock_photo_field_missing_provider'];
      }
      else {
        $url = FALSE;
