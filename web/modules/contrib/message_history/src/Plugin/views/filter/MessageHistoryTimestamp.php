...
namespace Drupal\message_history\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("message_history_timestamp")
 */
class MessageHistoryTimestamp extends FilterPluginBase {
  ...
  public function query() {
    ...
    $message = $this->query->ensureTable('message_field_data', $this->relationship);
    ...
    $this->query->addWhereExpression($this->options['group'], "($field IS NULL AND ($message.created > (***CURRENT_TIME*** - $limit))) OR $field < $message.created");
  }
