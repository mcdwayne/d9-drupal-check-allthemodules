...
/**
 * Tests the prorater plugin with a rollover interval.
 *
 * @group commerce_prorater_stepped_proportional
 */
class SteppedProportionalWithRolloverTest extends RecurringKernelTestBase {
   ...
   * $expected_price, $partial_period_start_time
   */
  ...
  public function dataProviderTestProrating() {
    return [
      ...
      'jan_1_rollover' => [
        ...
        '2017-12-13 21:00',
        // Pay the full amount for the following billing period.
        new Price('30.00', 'USD'),
      ],
      ...
      'feb_1_rollover' => [
        ...
        '2018-01-13 21:00',
        // Pay the full amount for the following billing period.
        new Price('30.00', 'USD'), // WTF? SHOULD FAIL.
      ],
    ];
  }

  public function dataProviderTestProratingRollover() {
    return [
    ];
  }
