...
/**
 * Defines the translation handler for Messages.
 */
class MessageTranslationHandler extends ContentTranslationHandler {

  /**
   * {@inheritdoc}
   */
  public function entityFormAlter(
    array &$form,
    ...
    if (isset($form['content_translation'])) {
      // We do not need to show these values on Message forms: they inherit the
      // basic Message property values.
  ...
  protected function entityFormTitle(EntityInterface $entity) {
    $type_name = MessageType::load($entity->bundle())->label();

    // @I Use string translation trait
    return t(
      '<em>Edit @type</em> @title',
      ['@type' => $type_name, '@title' => $entity->label()]
    );
  }
   ...
   * {@inheritdoc}
   */
  public function entityFormEntityBuild(
    $entity_type,
    EntityInterface $entity,
    array $form,
    FormStateInterface $form_state
    ...
    if ($form_state->hasValue('content_translation')) {
      ...
      $translation['created'] = format_date(
