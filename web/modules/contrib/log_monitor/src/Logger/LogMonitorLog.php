...
namespace Drupal\log_monitor\Logger;
 ...
 */
class LogMonitorLog implements LoggerInterface {
  use RfcLoggerTrait;
   ...
   */
  const DEDICATED_DBLOG_CONNECTION_TARGET = 'dedicated_log_monitor';

  const STATUS_NEEDS_VALIDATION = 0;
    ...
    try {
      $this->connection
        ...
        ->fields([
          ...
          'status' => self::STATUS_NEEDS_VALIDATION,
        ])
        ->execute();
    }
    catch (\Exception $e) {
