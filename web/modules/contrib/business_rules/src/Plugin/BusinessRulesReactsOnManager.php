 ...
 */
class BusinessRulesReactsOnManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $this->alterInfo('business_rules_reacts_on_info');
    $this->setCacheBackend($cache_backend, 'business_rules_reacts_on_plugins');
  }
