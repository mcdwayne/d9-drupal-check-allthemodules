...
class OAuthUtil {
  ...
  public static function build_http_query($params) {
    ...
    if(isset($params['oauth_callback']) && $params['oauth_callback']!='') {
      $params['oauth_callback'] = rawurlencode($params['oauth_callback']);
    }    

    if(isset($params['oauth_signature']) && $params['oauth_signature']!='') {
      $params['oauth_signature'] = str_replace('=', '%3D', str_replace('+', '%2B', $params['oauth_signature']));
    }
