...
class OAuthSignatureMethod_PLAINTEXT extends OAuthSignatureMethod {
   ...
   * Consumer Secret and Token Secret, separated by a '&' character 
   * (ASCII code 38), even if either secret is empty. The result MUST be
   * encoded again.
   * Please note that the second encoding MUST NOT happen in the 
   * SignatureMethod, as OAuthRequest handles this!
   */
