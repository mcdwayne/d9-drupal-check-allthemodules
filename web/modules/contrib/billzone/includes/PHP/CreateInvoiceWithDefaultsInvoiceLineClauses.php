...
//Számla tétel záradék létrehozása
$ClauseList[] = new ClauseItem();
$ClauseItem = new ClauseItem();

$Parameters[] = new ClauseParameterItemBase();
$Parameters[0] = new ClauseStringParameterItem();
$Parameters[0] -> Name = 'param1';
$Parameters[0] -> Value = 'Paraméter érték';

$Parameters[1] = new ClauseStringParameterItem();
$Parameters[1] -> Name = 'param2';
$Parameters[1] -> Value = 'Paraméter érték';

$ClauseItem -> Id = 'TEST_CLAUSE_1';
$ClauseItem -> Parameters = $Parameters;

$ClauseList[0] = $ClauseItem;     

$InvoiceLineIdentifier1 -> Clauses = $ClauseList;
...
$CreateInvoiceRequest -> RequestId = '1155';
