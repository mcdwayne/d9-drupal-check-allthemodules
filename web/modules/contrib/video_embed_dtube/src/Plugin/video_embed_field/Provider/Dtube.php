...
namespace Drupal\video_embed_dtube\Plugin\video_embed_field\Provider;
 ...
 * @VideoEmbedProvider(
 *   id = "dtube",
 *   title = @Translation("Dtube")
 * )
 */
class Dtube extends ProviderPluginBase {
  ...
  public function renderEmbedCode($width, $height, $autoplay) {
    ...
    return [
      ...
      '#attributes' => [
        ...
        'src' => sprintf('https://skzap.github.io/embedtube/#!/%s', $this->getVideoId(), $autoplay),
      ],
    ];
  }
  ...
  public static function getIdFromInput($input) {
    ...
    preg_match('/^https?:\/\/(www\.)?(dtube.video\/\#\!\/v\/)(?<id>.*)/', $input, $matches);
