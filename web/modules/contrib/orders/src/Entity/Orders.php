 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/idcp/orders/{orders}",
 *     "add-page" = "/admin/idcp/orders/add",
 *     "add-form" = "/admin/idcp/orders/add/{orders_type}",
 *     "edit-form" = "/admin/idcp/orders/{orders}/edit",
 *     "delete-form" = "/admin/idcp/orders/{orders}/delete",
 *     "version-history" = "/admin/idcp/orders/{orders}/revisions",
 *     "revision" = "/admin/idcp/orders/{orders}/revisions/{orders_revision}/view",
 *     "revision_revert" = "/admin/idcp/orders/{orders}/revisions/{orders_revision}/revert",
 *     "revision_delete" = "/admin/idcp/orders/{orders}/revisions/{orders_revision}/delete",
 *     "translation_revert" = "/admin/idcp/orders/{orders}/revisions/{orders_revision}/revert/{langcode}",
 *     "collection" = "/admin/idcp/orders",
 *   },
