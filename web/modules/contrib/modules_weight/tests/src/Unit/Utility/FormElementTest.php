...
class FormElementTest extends UnitTestCase {
  ...
  public function providerGetMaxDelta() {
    ...
    $tests['value lower than -100 - 2'] = [234, -234];
    $tests['value lower than 100 and higher than -100 - 1'] = [100, 35];
    $tests['value lower than 100 and higher than -100 - 2'] = [100, 33];
    $tests['value lower than 100 and higher than -100 - 3'] = [100, -33];
    $tests['value lower than 100 and higher than -100 - 4'] = [100, -35];
