...
/**
 * Test integration with Paragraphs when using Content Moderation.
 *
 * @group media_reference_revisions
 */
class ForwardParagraphsIntegrationTest extends BrowserTestBase {
  ...
  public function testItWorks() {
    ...
    // This will be updated the media item was updated directly.
    ...
    $this->drupalGet('node/1');
    $this->assertResponse(200);
    // Confirm that the node loads the old revision.
    $this->assertText('Test node');
    $this->assertText('Just a little test node.');
