 ...
 */
class ContentEntityModifyStatusTab extends LocalTaskDefault implements ContainerFactoryPluginInterface {
  ...
  public function getTitle(Request $request = NULL) {
    if (!is_null($this->getEntity())) {
      $status_key = $this->getEntity()->getEntityType()->getKey('status');
      $status = $this->getEntity()->get($status_key)->get(0)->value;
