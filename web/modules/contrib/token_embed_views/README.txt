...
To enable this module, visit Manage -> Extend, and enable
token_embed_views.
...
need to enable the "Replaces global and entity tokens with their values" filter in your text formats in the
