    ...
    attach: function (context, settings) {
      ...
      $('a.jcpopup').click(function() {
        ...
        if (ids.length >= 2) {
          ...
          var div = $('<div id="calpopup"><div id="popup-close"><img id="popup-close-img" src="' + drupalSettings.jcalendarPath + '/images/cross.png" /></div><div id="calpopup-body"><img src="' + drupalSettings.jcalendarPath + '/images/throbber.gif" id="popthrobber" /></div></div>').attr('style','display: none');
          ...
          $.ajax({
            type: "GET",
            url: drupalSettings.basePath + "?q=jcalendar/getnode/" + nid + "/" + ids,
