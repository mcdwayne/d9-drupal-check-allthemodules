...
use Drupal\user_bundle\TypedUserStorage;
use Drupal\Core\Language\LanguageInterface;
use Drupal\bundle_override_user\Plugin\bundle_override\EntityTypes\UserBPluginManager;
 ...
 */
class UserBStorage extends TypedUserStorage {
  ...
  protected function mapFromStorageRecords(array $records, $load_from_revision = FALSE) {
    ...
    foreach ($values as $id => $entity_values) {
      ...
      $entities[$id] = UserBPluginManager::me()
  ...
  public function create(array $values = []) {
    ...
    return static::createFromPluginManagerClassName($parentNamespace . '\\UserBPluginManager', $values);
  }
