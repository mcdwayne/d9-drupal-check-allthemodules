...
class CheckoutSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $anon_state = ['visible' => ['input[name="uc_checkout_anonymous"]' => ['checked' => TRUE]]];
    ...
    $form['checkout']['panes'] = [
      ...
      '#header' => [
        $this->t('Pane'),
        ['data' => $this->t('List postion'), 'colspan' => 2, 'class' => [RESPONSIVE_PRIORITY_LOW]],
      ],
      '#tabledrag' => [
        [
          'action' => 'order',
