 ...
 *
 * @FieldWidget(
 *   id = "moderation_state_dropbutton",
 *   label = @Translation("Moderation state dropbutton"),
 *   field_types = {
 *     "string"
 *   }
 * )
...
class ModerationStateWidget extends OptionsSelectWidget implements ContainerFactoryPluginInterface {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element += [
      ...
      // @todo Hacks to work around assumptions about the widget in core
      // https://www.drupal.org/node/2914839.
      'current' => ['#markup' => ''],
    ];
