 ...
 *
 */
class IntelliController3 extends ControllerBase {
  ...
  public function adminOverview(Request $request) {
    ...
    $build['path_table'] = [
      ...
      '#header' => $header,
      '#rows' => $rows,
      '#empty' => $this->t('No settings available. <a href=":link">Add Settings</a>.', [':link' => $this->url('intelligent_tools_text_summarize_addone.settings')]),
    ];
