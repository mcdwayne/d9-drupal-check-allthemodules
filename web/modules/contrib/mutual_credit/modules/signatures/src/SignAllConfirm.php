...
class SignAllConfirm extends ConfirmFormBase {
  ...
  public function form() {
    $this->messenger->addWarning('this page is untested. Whose signatures are we signing? CurrentUser?');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $transaction->save();
    $this->messenger()->addStatus(t('All the transactions have been signed.'));
