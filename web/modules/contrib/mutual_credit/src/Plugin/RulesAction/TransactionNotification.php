...
class TransactionNotification extends RulesActionBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    \Drupal::messenger()->addWarning('At time of writing (d8 alpha 14) there is no way to trigger actions so this action is untested');
    $w = 0;
    ...
    // This helps in the fieldset validation.
      '#name' => 'worth_items',
      '#description' => t('If either wallet cannot access a currency, an intertrading transaction will be attempted. Failure will produce a warning on screen and in the log.'),
      'worth' => array(
        // '#title' => t('Worths'),.
        '#type' => 'worth',
