...
class WalletSelection extends DefaultSelection {
   ...
   *
   * @return array
   *   All the wallets not passed
   */
  public function inverse(array $ids = []) {
    $entities = $this->getReferenceableEntities();
    return array_diff(array_keys($entities['mcapi_wallet']), $ids);
  }
}
