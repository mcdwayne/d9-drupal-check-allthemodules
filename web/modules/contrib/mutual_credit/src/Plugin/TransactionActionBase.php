...
abstract class TransactionActionBase extends ConfigurableActionBase implements TransactionActionInterface {
   ...
   * Constructor.
   */
  public function __construct(array $configuration, $plugin_id, array $plugin_definition, $entity_form_builder, $module_handler, $transaction_relative_manager, $entity_type_manager, $entity_display_respository, $current_user, MessengerInterface $messenger) {
  ...
  public function execute($object = NULL) {
    ...
    if ($this->configuration['message']) {
      $this->messenger->addStatus($this->configuration['message']);
    }
  }
