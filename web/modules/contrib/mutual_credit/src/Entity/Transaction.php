...
class Transaction extends ContentEntityBase implements TransactionInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['type'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDisplayConfigurable('view', TRUE)
      ->setDisplayConfigurable('form', TRUE)
      ->setDisplayOptions('form', ['region' => 'hidden']) // This should hide it by default
      ->addPropertyConstraints('target_id', [
        'AllowedValues' => ['callback' =>  ['Drupal\mcapi\Mcapi', 'getAllowedTransactionTypes']],
      ])
      ->setReadOnly(TRUE)
      ->setRequired(TRUE);
    ...
    $fields['state'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDisplayConfigurable('view', TRUE)
      ->addPropertyConstraints('target_id', [
        'AllowedValues' => ['callback' => ['Drupal\mcapi\Mcapi', 'getAllowedTransactionStates']],
      ])
      ->setReadOnly(FALSE)
      ->setRequired(TRUE);
    return $fields;
