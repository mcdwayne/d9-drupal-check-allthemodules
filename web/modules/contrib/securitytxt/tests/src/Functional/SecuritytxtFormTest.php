...
class SecuritytxtFormTest extends SecuritytxtBaseTest {
  ...
  public function testValidConfigurationSubmission() {
    ...
    $this->assertSession()->fieldValueEquals('contact_url', $valid_configuration['contact_url']);
    ...
    $this->assertSession()->responseContains('Contact: ' . $valid_configuration['contact_url']);
