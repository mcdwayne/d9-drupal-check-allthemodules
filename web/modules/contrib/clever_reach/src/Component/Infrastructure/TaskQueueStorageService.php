...
use Drupal\clever_reach\Component\Repository\QueueRepository;
...
class TaskQueueStorageService implements TaskQueueStorage {
  /**
   * Task queue repository instance.
   *
   * @var \Drupal\clever_reach\Component\Repository\QueueRepository
   */
   ...
   *
   * @param \CleverReach\Infrastructure\TaskExecution\QueueItem|null $queueItem
   *   Queue item to be converted.
  ...
  private function updateQueueItem($queueItem, array $conditions = []) {
    // CORE can give additional conditions to preserve updating item
    // that is possibly locked or already updated
