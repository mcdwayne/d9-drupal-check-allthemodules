...
class BaseRepository {
   ...
   *
   * @return array
   *   Array of arrays that matches provided filter.
   */
  public function findAll($filterBy = NULL, $sortBy = NULL, $start = 0, $limit = 0, array $select = NULL) {
