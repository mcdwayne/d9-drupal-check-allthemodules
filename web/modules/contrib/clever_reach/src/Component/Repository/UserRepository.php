...
class UserRepository {
  ...
  /**
   * Gets user IDs by provided filters.
   *
   * If filters are not set, all users will be returned.
   *
  ...
  /**
   * Gets users by provided filters.
   *
   * If filters are not set, all users will be returned.
   *
   * @param array|null $filterBy
   ...
   *   List of users that matches provided filter.
   */
