 ...
 */
class SimplySignupsFieldsCheckboxesForm extends FormBase {
  ...
  public function getFormId() {
    return 'simply_signups_fields_checkboxes_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes'] = [
      'class' => ['simply-signups-fields-checkboxes-form', 'simply-signups-form'],
    ];
    $form['request'] = [
      '#type' => 'hidden',
      '#value' => $request,
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $sanitizedOptions = SimplySignupsUtility::sanitizeOptions($textareaOptions);
    $field = [
      '#type' => $values['type'],
