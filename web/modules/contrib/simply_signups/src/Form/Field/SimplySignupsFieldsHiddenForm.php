 ...
 */
class SimplySignupsFieldsHiddenForm extends FormBase {
  ...
  public function getFormId() {
    return 'simply_signups_fields_hidden_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes'] = [
      'class' => ['simply-signups-fields-hidden-form', 'simply-signups-form'],
    ];
    $form['request'] = [
      '#type' => 'hidden',
      '#value' => $request,
    ...
    $form['default_value_input']['value'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Value'),
      '#required' => TRUE,
