 ...
 */
class SimplySignupsFieldsTelForm extends FormBase {
  ...
  public function getFormId() {
    return 'simply_signups_fields_tel_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes'] = [
      'class' => ['simply-signups-fields-tel-form', 'simply-signups-form'],
    ];
    $form['request'] = [
      '#type' => 'hidden',
      '#value' => $request,
    ...
    $form['size'] = [
      ...
      '#min' => 1,
      '#required' => TRUE,
      '#default_value' => (isset($field['#size'])) ? $field['#size'] : 30,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $field = [
      ...
      '#size' => (!empty($values['size'])) ? $values['size'] : 30,
