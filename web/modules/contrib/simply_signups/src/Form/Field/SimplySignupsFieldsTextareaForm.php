 ...
 */
class SimplySignupsFieldsTextareaForm extends FormBase {
  ...
  public function getFormId() {
    return 'simply_signups_fields_textarea_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes'] = [
      'class' => ['simply-signups-fields-textarea-form', 'simply-signups-form'],
    ];
    $form['request'] = [
      '#type' => 'hidden',
      '#value' => $request,
    ...
    $form['cols'] = [
      ...
      '#min' => 1,
      '#required' => TRUE,
      '#default_value' => (isset($field['#cols'])) ? $field['#cols'] : 60,
    ];
    $form['rows'] = [
      '#type' => 'number',
      '#title' => $this->t('Rows'),
      ...
      '#min' => 1,
      '#required' => TRUE,
      '#default_value' => (isset($field['#rows'])) ? $field['#rows'] : 5,
    ];
    $form['actions'] = [
      '#type' => 'actions',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $field = [
      ...
      '#cols' => (!empty($values['cols'])) ? $values['cols'] : 60,
      '#rows' => (!empty($values['rows'])) ? $values['rows'] : 5,
    ];
    $db = $this->database;
