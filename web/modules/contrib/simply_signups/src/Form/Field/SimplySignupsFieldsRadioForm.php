 ...
 */
class SimplySignupsFieldsRadioForm extends FormBase {
  ...
  public function getFormId() {
    return 'simply_signups_fields_radio_add_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes'] = [
      'class' => ['simply-signups-fields-radio-form', 'simply-signups-form'],
    ];
    $form['request'] = [
      '#type' => 'hidden',
      '#value' => $request,
    ...
    $form['return_value'] = [
      ...
      '#description' => $this->t('The value to return when the radio is selected'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $field = [
      ...
      '#return_value' => (!empty($values['return_value'])) ? $values['return_value'] : '',
    ];
    $db = $this->database;
