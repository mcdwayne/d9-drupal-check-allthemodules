 ...
 */
class SimplySignupsFieldsRadiosForm extends FormBase {
  ...
  public function getFormId() {
    return 'simply_signups_fields_radios_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['#attributes'] = [
      'class' => ['simply-signups-fields-radios-form', 'simply-signups-form'],
    ];
    $form['request'] = [
      '#type' => 'hidden',
      '#value' => $request,
