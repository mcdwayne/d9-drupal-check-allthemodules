...
/**
 * Class GeneralCreatorRule.
 *
 * @package Drupal\local_translation_content\Plugin\LocalTranslationAccessRules
 *
 * @LocalTranslationAccessRule("local_translation_content_general_creator")
 */
class GeneralCreatorRule extends AccessRuleBase {
  ...
  protected function addDynamicPermissions(ContentEntityInterface $entity) {
    $this->permissions[] = "local_translation_content create {$entity->bundle()} content";
  }
