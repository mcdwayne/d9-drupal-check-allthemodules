...
namespace Drupal\commerce_pagseguro_transp\Form;
...
class PrepareModulesEntityUninstallForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'commerce_pagseguro_transp_prepare_modules_entity_uninstall';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $entity_type_id = NULL, $bundle_id = NULL) {
    ...
    $count = $storage->getQuery()->condition('type', $bundle_id)->count()->execute();
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $bundle_id = $form_state->getValue('bundle_id');
    ...
    $batch = [
      ...
      'operations' => [
        [
          [__CLASS__, 'deleteContentEntities'], [$entity_type_id, $bundle_id],
        ],
      ],
   ...
   */
  public static function deleteContentEntities($entity_type_id, $bundle_id, &$context) {
    ...
    if (!isset($context['sandbox']['progress'])) {
      ...
      $context['sandbox']['max'] = $storage->getQuery()->condition('type', $bundle_id)->count()->execute();
    }
    ...
    $context['sandbox']['progress'] = $context['sandbox']['max'] - $storage->getQuery()->condition('type', $bundle_id)->count()->execute();
