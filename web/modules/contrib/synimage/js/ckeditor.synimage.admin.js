/**
 * @file
 * CKEditor 'imagesynbox' plugin admin behavior.
 */
...
(function ($, Drupal, drupalSettings) {
  ...
  /**
   * Provides the summary for the "imagesynbox" plugin settings vertical tab.
   *
   * @type {Drupal~behavior}
   *
   * @prop {Drupal~behaviorAttach} attach
   *   Attaches summary behaviour to the "imagesynbox" settings vertical tab.
   */
  Drupal.behaviors.ckeditorImageSynboxSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="imagesynbox"]').drupalSetSummary(function (context) {
        var root = 'input[name="editor[settings][plugins][imagesynbox][image_upload]';
