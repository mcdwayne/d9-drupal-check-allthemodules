...
namespace Drupal\page_cache_dnt_aware\StackMiddleware;
 ...
 * overrides core PageCache CID.
 */
class PageCacheDNTAware implements HttpKernelInterface {
  ...
  protected function getCacheId(Request $request) {
    $cid_parts = [
      ...
      $request->getRequestFormat(), $request->headers->get('DNT') ? "DNT": "NODNT",
    ];
