 ...
 * altered by the Drupal Image plugin, to allow for the data-action
 * attribute to be set.
 *
 * @ignore
 */
...
(function (CKEDITOR) {
    ...
    CKEDITOR.plugins.add('drupalinlineimagezoom', {
        ...
        beforeInit: function (editor) {
            ...
            editor.on('widgetDefinition', function (event) {
                ...
                CKEDITOR.tools.extend(widgetDefinition.features, {
                    responsiveimage: {
                        requiredContent: 'img[data-action]'
                    }
                }, true);

                // Override requiredContent & allowedContent.
                var requiredContent = widgetDefinition.requiredContent.getDefinition();
                requiredContent.attributes['data-action'] = '';
                widgetDefinition.requiredContent = new CKEDITOR.style(requiredContent);
                widgetDefinition.allowedContent.img.attributes['!data-action'] = true;
                ...
                widgetDefinition.downcast = function (element) {
                    ...
                    img.attributes['data-action'] = this.data['data-action'];
                    return img;
                };
                ...
                widgetDefinition.upcast = function (element, data) {
                    ...
                    data['data-action'] = element.attributes['data-action'];
