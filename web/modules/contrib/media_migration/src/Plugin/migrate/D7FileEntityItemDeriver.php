  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    try {
      foreach ($types as $row) {
        ...
        // If this media type does not exist yet, continue to the next one.
        if (empty($media_type)) {
          continue;
        }
        ...
        $values['process'][$source_field_name . '/target_id'] = 'fid';

        // Map width and height for image entities.
        if ($bundle_name == 'image') {
          $values['process'][$source_field_name . '/width'] = 'width';
          $values['process'][$source_field_name . '/height'] = 'height';
          $values['process']['thumbnail/target_id'] = 'fid';
          $values['process']['thumbnail/width'] = 'width';
          $values['process']['thumbnail/height'] = 'height';
        }
