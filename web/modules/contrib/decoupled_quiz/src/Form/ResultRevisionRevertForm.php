...
class ResultRevisionRevertForm extends ConfirmFormBase {
   ...
   * The Result revision.
   *
   * @var \Drupal\decoupled_quiz\Entity\ResultInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message(t('Result %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\decoupled_quiz\Entity\ResultInterface $revision
