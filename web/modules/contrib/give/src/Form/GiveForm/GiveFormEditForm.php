...
class GiveFormEditForm extends EntityForm implements ContainerInjectionInterface {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    if ($form_state->getValue('autoreply')) {
      $form['autoreply_fields']['_available_tokens'] = [
        '#type' => 'item',
      ...
      $reply_onetime_default = is_array($give_form->getReply()) ? $give_form->getReply()['value'] : $give_form->getReply();
      $form['autoreply_fields']['onetime']['reply'] = [
        '#type' => 'text_format',
        '#format' => give_format(),
        '#allowed_formats' => [give_format()],
        '#title' => $this->t('Message'),
        '#default_value' => $reply_onetime_default,
        '#description' => $this->t('This should include your organization name and any relevant tax information.'),
        '#required' => TRUE,
      ];
      $form['autoreply_fields']['recurring'] = [
        '#type' => 'fieldset',
        '#title' => $this->t('Recurring donation reply'),
        '#collapsible' => TRUE,
      ];
      $form['autoreply_fields']['recurring']['subject_recurring'] = [
        '#type' => 'textfield',
        '#title' => $this->t('Subject'),
      ...
      $reply_recurring_default = is_array($give_form->get('reply_recurring')) ? $give_form->get('reply_recurring')['value'] : $give_form->get('reply_recurring');
      $form['autoreply_fields']['recurring']['reply_recurring'] = [
        '#type' => 'text_format',
        '#format' => give_format(),
        '#allowed_formats' => [give_format()],
        '#title' => $this->t('Auto-reply to recurring donation with receipt'),
        '#default_value' => $reply_recurring_default,
        '#description' => $this->t('This should include your organization name and any relevant tax information.'),
        '#required' => TRUE,
      ];
      $form['autoreply_fields']['pledge'] = [
        '#type' => 'fieldset',
        '#title' => $this->t('Check (pledged) donation reply'),
        '#collapsible' => TRUE,
      ];
      $form['autoreply_fields']['pledge']['subject_pledge'] = [
        '#type' => 'textfield',
        '#title' => $this->t('Subject'),
      ...
      $reply_pleage_default = is_array($give_form->get('reply_pledge')) ? $give_form->get('reply_pledge')['value'] : $give_form->get('reply_pledge');
      $form['autoreply_fields']['pledge']['reply_pledge'] = [
        '#type' => 'text_format',
        '#format' => give_format(),
        '#allowed_formats' => [give_format()],
        '#title' => $this->t('Auto-reply with receipt'),
        '#default_value' => $reply_pleage_default,
    ...
    $form['donor_name_description'] = [
      '#type' => 'textfield',
      '#title' => t('Donor name description'),
      '#description' => t("This text is shown under the donor name on the payment page (the second page in the donation process)."),
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach (['reply', 'reply_recurring', 'reply_pledge', 'check_or_other_text', 'credit_card_extra_text'] as $wysiwygd_field) {
