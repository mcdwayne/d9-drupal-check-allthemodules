...
class ModalForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $nojs = NULL) {
    ...
    //$form['editor_table'] = $this->editor_note_get_formatted_notes($field, $notes, TRUE);
    $form['editor_table'] = \Drupal::service('editor_note.helper')->generateTable($field, $notes, TRUE);

    $form['editor_note'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Editor Note'),
      '#weight' => '0',
    ];
