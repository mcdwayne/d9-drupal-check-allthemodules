...
---------------------
 * Drupal 8 Version with latest 2.2.6 version of Semantic UI
 * Introduction
 * Installation
 
Drupal 8 Version
------------
Heavy Development - Please use only for testing purpose
...
and place inside your module directory. ("/modules/contrib").
...
3. Download & extract semantic.zip file of "Semantic UI" 
  ...
  into -  "/libraries/semantic_ui" directory.

4. Confirm that "semantic.min.css" file is
  inside "/libraries/semantic_ui/css" directory
  and "semantic.min.js" file is inside
  "/libraries/semantic_ui/javascript" directory.
