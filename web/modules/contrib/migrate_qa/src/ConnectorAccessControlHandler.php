...
class ConnectorAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    ...
    switch ($operation) {
      case 'view':
        return AccessResult::allowedIfHasPermission($account, 'view migrate_qa_connector entity');

      case 'update':
        return AccessResult::allowedIfHasPermission($account, 'edit migrate_qa_connector entity');

      case 'delete':
        return AccessResult::allowedIfHasPermission($account, 'delete migrate_qa_connector entity');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    ...
    return AccessResult::allowedIfHasPermission($account, 'add migrate_qa_connector entity');
  }
}
