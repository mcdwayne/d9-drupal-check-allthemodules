...
class TrackerAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    ...
    switch ($operation) {
      case 'view':
        return AccessResult::allowedIfHasPermission($account, 'view migrate_qa_tracker entity');

      case 'update':
        return AccessResult::allowedIfHasPermission($account, 'edit migrate_qa_tracker entity');

      case 'delete':
        return AccessResult::allowedIfHasPermission($account, 'delete migrate_qa_tracker entity');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    ...
    return AccessResult::allowedIfHasPermission($account, 'add migrate_qa_tracker entity');
  }
}
